...
/// Orchestration and serialization glue logic for `CreateSubscriptionToken`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateSubscriptionToken;
impl CreateSubscriptionToken {
    /// Creates a new `CreateSubscriptionToken`
    pub fn new() -> Self {
        Self
    }
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_subscription_token::CreateSubscriptionTokenError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_subscription_token::CreateSubscriptionTokenOutput>()
        ...
        runtime_plugins = runtime_plugins
            .with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
                |token_provider, input| {
                    let input: &mut crate::operation::create_subscription_token::CreateSubscriptionTokenInput =
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateSubscriptionToken {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateSubscriptionToken");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateSubscriptionTokenRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                CreateSubscriptionTokenResponseDeserializer,
            ),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(CreateSubscriptionTokenEndpointParamsInterceptor)
...
#[derive(Debug)]
struct CreateSubscriptionTokenResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateSubscriptionTokenResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_subscription_token::de_create_subscription_token_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_subscription_token::de_create_subscription_token_http_response(
                status, headers, body,
            )
        };
...
#[derive(Debug)]
struct CreateSubscriptionTokenRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateSubscriptionTokenRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::create_subscription_token::CreateSubscriptionTokenInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::create_subscription_token::CreateSubscriptionTokenInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonCodeWhispererService.CreateSubscriptionToken",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_subscription_token::ser_create_subscription_token_input(&input)?,
        );
...
#[derive(Debug)]
struct CreateSubscriptionTokenEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateSubscriptionTokenEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "CreateSubscriptionTokenEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<CreateSubscriptionTokenInput>()
            .ok_or("failed to downcast to CreateSubscriptionTokenInput")?;
...
/// Error type for the `CreateSubscriptionTokenError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum CreateSubscriptionTokenError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateSubscriptionTokenError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl CreateSubscriptionTokenError {
    /// Creates the `CreateSubscriptionTokenError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `CreateSubscriptionTokenError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `CreateSubscriptionTokenError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `CreateSubscriptionTokenError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `CreateSubscriptionTokenError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is `CreateSubscriptionTokenError::ThrottlingError`.
    pub fn is_throttling_error(&self) -> bool {
        matches!(self, Self::ThrottlingError(_))
    }

    /// Returns `true` if the error kind is `CreateSubscriptionTokenError::ConflictError`.
    pub fn is_conflict_error(&self) -> bool {
        matches!(self, Self::ConflictError(_))
    }
}
impl ::std::error::Error for CreateSubscriptionTokenError {
...
impl ::std::fmt::Display for CreateSubscriptionTokenError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for CreateSubscriptionTokenError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateSubscriptionTokenError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateSubscriptionTokenError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_subscription_token::CreateSubscriptionTokenError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use crate::operation::create_subscription_token::_create_subscription_token_input::CreateSubscriptionTokenInput;
pub use crate::operation::create_subscription_token::_create_subscription_token_output::CreateSubscriptionTokenOutput;

mod _create_subscription_token_input;

mod _create_subscription_token_output;
