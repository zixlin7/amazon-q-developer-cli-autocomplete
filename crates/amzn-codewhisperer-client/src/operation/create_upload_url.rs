...
/// Orchestration and serialization glue logic for `CreateUploadUrl`.
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_upload_url::CreateUploadUrlError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_upload_url::CreateUploadUrlOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateUploadUrl {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateUploadUrl");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateUploadUrlRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                CreateUploadUrlResponseDeserializer,
            ),
        );
...
#[derive(Debug)]
struct CreateUploadUrlResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateUploadUrlResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_upload_url::de_create_upload_url_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_create_upload_url::de_create_upload_url_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct CreateUploadUrlRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateUploadUrlRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::create_upload_url::CreateUploadUrlInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::create_upload_url::CreateUploadUrlInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonCodeWhispererService.CreateUploadUrl",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_upload_url::ser_create_upload_url_input(&input)?,
        );
...
#[derive(Debug)]
struct CreateUploadUrlEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateUploadUrlEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "CreateUploadUrlEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<CreateUploadUrlInput>()
            .ok_or("failed to downcast to CreateUploadUrlInput")?;
...
pub enum CreateUploadUrlError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateUploadUrlError) for what information is available for the error."
    )]
...
impl CreateUploadUrlError {
    ...
    /// Creates the `CreateUploadUrlError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `CreateUploadUrlError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `CreateUploadUrlError::ValidationError`.
    ...
    /// Returns `true` if the error kind is `CreateUploadUrlError::ResourceNotFoundError`.
    ...
    /// Returns `true` if the error kind is `CreateUploadUrlError::ConflictError`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateUploadUrlError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_upload_url::CreateUploadUrlError {
