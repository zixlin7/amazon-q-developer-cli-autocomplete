...
/// Orchestration and serialization glue logic for `CreateUserMemoryEntry`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateUserMemoryEntry;
impl CreateUserMemoryEntry {
    /// Creates a new `CreateUserMemoryEntry`
    pub fn new() -> Self {
        Self
    }
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_user_memory_entry::CreateUserMemoryEntryError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_user_memory_entry::CreateUserMemoryEntryOutput>()
        ...
        runtime_plugins = runtime_plugins
            .with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
                |token_provider, input| {
                    let input: &mut crate::operation::create_user_memory_entry::CreateUserMemoryEntryInput =
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateUserMemoryEntry {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateUserMemoryEntry");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateUserMemoryEntryRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                CreateUserMemoryEntryResponseDeserializer,
            ),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(CreateUserMemoryEntryEndpointParamsInterceptor)
...
#[derive(Debug)]
struct CreateUserMemoryEntryResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateUserMemoryEntryResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_user_memory_entry::de_create_user_memory_entry_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_user_memory_entry::de_create_user_memory_entry_http_response(
                status, headers, body,
            )
        };
...
#[derive(Debug)]
struct CreateUserMemoryEntryRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateUserMemoryEntryRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::create_user_memory_entry::CreateUserMemoryEntryInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::create_user_memory_entry::CreateUserMemoryEntryInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonCodeWhispererService.CreateUserMemoryEntry",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_user_memory_entry::ser_create_user_memory_entry_input(&input)?,
        );
...
#[derive(Debug)]
struct CreateUserMemoryEntryEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateUserMemoryEntryEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "CreateUserMemoryEntryEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<CreateUserMemoryEntryInput>()
            .ok_or("failed to downcast to CreateUserMemoryEntryInput")?;
...
/// Error type for the `CreateUserMemoryEntryError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum CreateUserMemoryEntryError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateUserMemoryEntryError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl CreateUserMemoryEntryError {
    /// Creates the `CreateUserMemoryEntryError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `CreateUserMemoryEntryError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `CreateUserMemoryEntryError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `CreateUserMemoryEntryError::ThrottlingError`.
    pub fn is_throttling_error(&self) -> bool {
        matches!(self, Self::ThrottlingError(_))
    }

    /// Returns `true` if the error kind is `CreateUserMemoryEntryError::ResourceNotFoundError`.
    pub fn is_resource_not_found_error(&self) -> bool {
        matches!(self, Self::ResourceNotFoundError(_))
    }

    /// Returns `true` if the error kind is `CreateUserMemoryEntryError::ServiceQuotaExceededError`.
    pub fn is_service_quota_exceeded_error(&self) -> bool {
        matches!(self, Self::ServiceQuotaExceededError(_))
    }

    /// Returns `true` if the error kind is `CreateUserMemoryEntryError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `CreateUserMemoryEntryError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }
}
impl ::std::error::Error for CreateUserMemoryEntryError {
...
impl ::std::fmt::Display for CreateUserMemoryEntryError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for CreateUserMemoryEntryError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateUserMemoryEntryError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateUserMemoryEntryError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_user_memory_entry::CreateUserMemoryEntryError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use crate::operation::create_user_memory_entry::_create_user_memory_entry_input::CreateUserMemoryEntryInput;
pub use crate::operation::create_user_memory_entry::_create_user_memory_entry_output::CreateUserMemoryEntryOutput;

mod _create_user_memory_entry_input;

mod _create_user_memory_entry_output;
