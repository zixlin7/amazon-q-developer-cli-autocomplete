...
/// Orchestration and serialization glue logic for `DeleteWorkspace`.
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::delete_workspace::DeleteWorkspaceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::delete_workspace::DeleteWorkspaceOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteWorkspace {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteWorkspace");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DeleteWorkspaceRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                DeleteWorkspaceResponseDeserializer,
            ),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(DeleteWorkspaceEndpointParamsInterceptor)
...
#[derive(Debug)]
struct DeleteWorkspaceResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteWorkspaceResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_delete_workspace::de_delete_workspace_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_delete_workspace::de_delete_workspace_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct DeleteWorkspaceRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteWorkspaceRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::delete_workspace::DeleteWorkspaceInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::delete_workspace::DeleteWorkspaceInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonCodeWhispererService.DeleteWorkspace",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_delete_workspace::ser_delete_workspace_input(&input)?,
        );
...
#[derive(Debug)]
struct DeleteWorkspaceEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteWorkspaceEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "DeleteWorkspaceEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<DeleteWorkspaceInput>()
            .ok_or("failed to downcast to DeleteWorkspaceInput")?;
...
pub enum DeleteWorkspaceError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteWorkspaceError) for what information is available for the error."
    )]
...
impl DeleteWorkspaceError {
    ...
    /// Creates the `DeleteWorkspaceError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `DeleteWorkspaceError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is `DeleteWorkspaceError::ThrottlingError`.
    pub fn is_throttling_error(&self) -> bool {
        matches!(self, Self::ThrottlingError(_))
    }

    /// Returns `true` if the error kind is `DeleteWorkspaceError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `DeleteWorkspaceError::AccessDeniedError`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteWorkspaceError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_workspace::DeleteWorkspaceError {
