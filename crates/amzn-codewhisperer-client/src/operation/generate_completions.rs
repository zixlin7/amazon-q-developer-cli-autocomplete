...
/// Orchestration and serialization glue logic for `GenerateCompletions`.
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::generate_completions::GenerateCompletionsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::generate_completions::GenerateCompletionsOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GenerateCompletions {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GenerateCompletions");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GenerateCompletionsRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                GenerateCompletionsResponseDeserializer,
            ),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(GenerateCompletionsEndpointParamsInterceptor)
...
#[derive(Debug)]
struct GenerateCompletionsResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GenerateCompletionsResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_generate_completions::de_generate_completions_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_generate_completions::de_generate_completions_http_response(
                status, headers, body,
            )
        };
...
#[derive(Debug)]
struct GenerateCompletionsRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GenerateCompletionsRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::generate_completions::GenerateCompletionsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::generate_completions::GenerateCompletionsInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonCodeWhispererService.GenerateCompletions",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_generate_completions::ser_generate_completions_input(&input)?,
        );
...
#[derive(Debug)]
struct GenerateCompletionsEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GenerateCompletionsEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "GenerateCompletionsEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<GenerateCompletionsInput>()
            .ok_or("failed to downcast to GenerateCompletionsInput")?;
...
/// Error type for the `GenerateCompletionsError` operation.
#[non_exhaustive]
...
pub enum GenerateCompletionsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GenerateCompletionsError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl GenerateCompletionsError {
    /// Creates the `GenerateCompletionsError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `GenerateCompletionsError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `GenerateCompletionsError::AccessDeniedError`.
...
impl ::aws_smithy_types::retry::ProvideErrorKind for GenerateCompletionsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GenerateCompletionsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::generate_completions::GenerateCompletionsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use crate::operation::generate_completions::_generate_completions_input::GenerateCompletionsInput;
pub use crate::operation::generate_completions::_generate_completions_output::GenerateCompletionsOutput;

mod _generate_completions_input;

mod _generate_completions_output;
