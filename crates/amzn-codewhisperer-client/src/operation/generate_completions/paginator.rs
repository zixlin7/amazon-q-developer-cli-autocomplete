...
/// Paginator for
/// [`GenerateCompletions`](crate::operation::generate_completions::GenerateCompletions)
pub struct GenerateCompletionsPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::generate_completions::builders::GenerateCompletionsInputBuilder,
    stop_on_duplicate_token: bool,
}

impl GenerateCompletionsPaginator {
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(
            ::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::generate_completions::GenerateCompletions::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token =
                                    crate::lens::reflens_generate_completions_output_output_next_token(resp);
