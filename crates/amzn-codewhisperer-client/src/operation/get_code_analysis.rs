...
/// Orchestration and serialization glue logic for `GetCodeAnalysis`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetCodeAnalysis;
impl GetCodeAnalysis {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_code_analysis::GetCodeAnalysisError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_code_analysis::GetCodeAnalysisOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetCodeAnalysis {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetCodeAnalysis");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetCodeAnalysisRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                GetCodeAnalysisResponseDeserializer,
            ),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(GetCodeAnalysisEndpointParamsInterceptor)
...
#[derive(Debug)]
struct GetCodeAnalysisResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetCodeAnalysisResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_code_analysis::de_get_code_analysis_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_get_code_analysis::de_get_code_analysis_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct GetCodeAnalysisRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetCodeAnalysisRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::get_code_analysis::GetCodeAnalysisInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonCodeWhispererService.GetCodeAnalysis",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_code_analysis::ser_get_code_analysis_input(&input)?,
        );
...
#[derive(Debug)]
struct GetCodeAnalysisEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetCodeAnalysisEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "GetCodeAnalysisEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<GetCodeAnalysisInput>()
            .ok_or("failed to downcast to GetCodeAnalysisInput")?;
...
/// Error type for the `GetCodeAnalysisError` operation.
#[non_exhaustive]
...
pub enum GetCodeAnalysisError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetCodeAnalysisError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl GetCodeAnalysisError {
    /// Creates the `GetCodeAnalysisError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `GetCodeAnalysisError::Unhandled` variant from an
...
impl ::aws_smithy_types::retry::ProvideErrorKind for GetCodeAnalysisError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetCodeAnalysisError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_code_analysis::GetCodeAnalysisError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use crate::operation::get_code_analysis::_get_code_analysis_input::GetCodeAnalysisInput;
pub use crate::operation::get_code_analysis::_get_code_analysis_output::GetCodeAnalysisOutput;

mod _get_code_analysis_input;

mod _get_code_analysis_output;
