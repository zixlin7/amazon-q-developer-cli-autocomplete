...
/// Orchestration and serialization glue logic for `GetCodeFixJob`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetCodeFixJob;
impl GetCodeFixJob {
    /// Creates a new `GetCodeFixJob`
    pub fn new() -> Self {
        Self
    }
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_code_fix_job::GetCodeFixJobError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_code_fix_job::GetCodeFixJobOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetCodeFixJob {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetCodeFixJob");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetCodeFixJobRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                GetCodeFixJobResponseDeserializer,
            ),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(GetCodeFixJobEndpointParamsInterceptor)
...
#[derive(Debug)]
struct GetCodeFixJobResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetCodeFixJobResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_code_fix_job::de_get_code_fix_job_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_get_code_fix_job::de_get_code_fix_job_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct GetCodeFixJobRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetCodeFixJobRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::get_code_fix_job::GetCodeFixJobInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonCodeWhispererService.GetCodeFixJob",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_code_fix_job::ser_get_code_fix_job_input(&input)?,
        );
...
#[derive(Debug)]
struct GetCodeFixJobEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetCodeFixJobEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "GetCodeFixJobEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<GetCodeFixJobInput>()
            .ok_or("failed to downcast to GetCodeFixJobInput")?;
...
/// Error type for the `GetCodeFixJobError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum GetCodeFixJobError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetCodeFixJobError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl GetCodeFixJobError {
    /// Creates the `GetCodeFixJobError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `GetCodeFixJobError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `GetCodeFixJobError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is `GetCodeFixJobError::ThrottlingError`.
    pub fn is_throttling_error(&self) -> bool {
        matches!(self, Self::ThrottlingError(_))
    }

    /// Returns `true` if the error kind is `GetCodeFixJobError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `GetCodeFixJobError::ResourceNotFoundError`.
    pub fn is_resource_not_found_error(&self) -> bool {
        matches!(self, Self::ResourceNotFoundError(_))
    }

    /// Returns `true` if the error kind is `GetCodeFixJobError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }
}
impl ::std::error::Error for GetCodeFixJobError {
...
impl ::std::fmt::Display for GetCodeFixJobError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for GetCodeFixJobError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetCodeFixJobError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetCodeFixJobError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_code_fix_job::GetCodeFixJobError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use crate::operation::get_code_fix_job::_get_code_fix_job_input::GetCodeFixJobInput;
pub use crate::operation::get_code_fix_job::_get_code_fix_job_output::GetCodeFixJobOutput;

mod _get_code_fix_job_input;

mod _get_code_fix_job_output;
