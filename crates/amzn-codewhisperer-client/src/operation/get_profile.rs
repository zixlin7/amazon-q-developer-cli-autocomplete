...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetProfile {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetProfileResponseDeserializer),
        );
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetProfileRequestSerializer {
    ...
    > {
        let input = input
            .downcast::<crate::operation::get_profile::GetProfileInput>()
            .expect("correct type");
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_profile::ser_get_profile_input(&input)?,
        );
...
impl GetProfileError {
    ...
    /// Creates the `GetProfileError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `GetProfileError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `GetProfileError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `GetProfileError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is `GetProfileError::ThrottlingError`.
    pub fn is_throttling_error(&self) -> bool {
        matches!(self, Self::ThrottlingError(_))
    }

    /// Returns `true` if the error kind is `GetProfileError::ResourceNotFoundError`.
