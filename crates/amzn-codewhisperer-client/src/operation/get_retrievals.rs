...
/// Orchestration and serialization glue logic for `GetRetrievals`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetRetrievals;
impl GetRetrievals {
    /// Creates a new `GetRetrievals`
    pub fn new() -> Self {
        Self
    }
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_retrievals::GetRetrievalsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_retrievals::GetRetrievalsOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetRetrievals {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetRetrievals");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetRetrievalsRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                GetRetrievalsResponseDeserializer,
            ),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(GetRetrievalsEndpointParamsInterceptor)
...
#[derive(Debug)]
struct GetRetrievalsResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetRetrievalsResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_retrievals::de_get_retrievals_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_get_retrievals::de_get_retrievals_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct GetRetrievalsRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetRetrievalsRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::get_retrievals::GetRetrievalsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::get_retrievals::GetRetrievalsInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonCodeWhispererService.GetRetrievals",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_retrievals::ser_get_retrievals_input(&input)?,
        );
...
#[derive(Debug)]
struct GetRetrievalsEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetRetrievalsEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "GetRetrievalsEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<GetRetrievalsInput>()
            .ok_or("failed to downcast to GetRetrievalsInput")?;
...
/// Error type for the `GetRetrievalsError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum GetRetrievalsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetRetrievalsError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl GetRetrievalsError {
    /// Creates the `GetRetrievalsError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `GetRetrievalsError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `GetRetrievalsError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `GetRetrievalsError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `GetRetrievalsError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is `GetRetrievalsError::ThrottlingError`.
    pub fn is_throttling_error(&self) -> bool {
        matches!(self, Self::ThrottlingError(_))
    }

    /// Returns `true` if the error kind is `GetRetrievalsError::ResourceNotFoundError`.
    pub fn is_resource_not_found_error(&self) -> bool {
        matches!(self, Self::ResourceNotFoundError(_))
    }
}
impl ::std::error::Error for GetRetrievalsError {
...
impl ::std::fmt::Display for GetRetrievalsError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for GetRetrievalsError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetRetrievalsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetRetrievalsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_retrievals::GetRetrievalsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use crate::operation::get_retrievals::_get_retrievals_input::GetRetrievalsInput;
pub use crate::operation::get_retrievals::_get_retrievals_output::GetRetrievalsOutput;

mod _get_retrievals_input;

mod _get_retrievals_output;
