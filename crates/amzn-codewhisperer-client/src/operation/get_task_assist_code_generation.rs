...
/// Orchestration and serialization glue logic for `GetTaskAssistCodeGeneration`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetTaskAssistCodeGeneration;
impl GetTaskAssistCodeGeneration {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_task_assist_code_generation::GetTaskAssistCodeGenerationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_task_assist_code_generation::GetTaskAssistCodeGenerationOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetTaskAssistCodeGeneration {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetTaskAssistCodeGeneration");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetTaskAssistCodeGenerationRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                GetTaskAssistCodeGenerationResponseDeserializer,
            ),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(GetTaskAssistCodeGenerationEndpointParamsInterceptor)
...
#[derive(Debug)]
struct GetTaskAssistCodeGenerationResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetTaskAssistCodeGenerationResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_task_assist_code_generation::de_get_task_assist_code_generation_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_task_assist_code_generation::de_get_task_assist_code_generation_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct GetTaskAssistCodeGenerationRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetTaskAssistCodeGenerationRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::get_task_assist_code_generation::GetTaskAssistCodeGenerationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonCodeWhispererService.GetTaskAssistCodeGeneration",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_task_assist_code_generation::ser_get_task_assist_code_generation_input(
                &input,
            )?,
        );
...
#[derive(Debug)]
struct GetTaskAssistCodeGenerationEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for GetTaskAssistCodeGenerationEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "GetTaskAssistCodeGenerationEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<GetTaskAssistCodeGenerationInput>()
            .ok_or("failed to downcast to GetTaskAssistCodeGenerationInput")?;
...
/// Error type for the `GetTaskAssistCodeGenerationError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum GetTaskAssistCodeGenerationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetTaskAssistCodeGenerationError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl GetTaskAssistCodeGenerationError {
    /// Creates the `GetTaskAssistCodeGenerationError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `GetTaskAssistCodeGenerationError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `GetTaskAssistCodeGenerationError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is `GetTaskAssistCodeGenerationError::ThrottlingError`.
    pub fn is_throttling_error(&self) -> bool {
        matches!(self, Self::ThrottlingError(_))
    }

    /// Returns `true` if the error kind is `GetTaskAssistCodeGenerationError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `GetTaskAssistCodeGenerationError::ConflictError`.
    pub fn is_conflict_error(&self) -> bool {
        matches!(self, Self::ConflictError(_))
    }

    /// Returns `true` if the error kind is
    /// `GetTaskAssistCodeGenerationError::ResourceNotFoundError`.
    pub fn is_resource_not_found_error(&self) -> bool {
        matches!(self, Self::ResourceNotFoundError(_))
    }

    /// Returns `true` if the error kind is `GetTaskAssistCodeGenerationError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }
}
impl ::std::error::Error for GetTaskAssistCodeGenerationError {
...
impl ::std::fmt::Display for GetTaskAssistCodeGenerationError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for GetTaskAssistCodeGenerationError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetTaskAssistCodeGenerationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetTaskAssistCodeGenerationError {
...
impl ::aws_types::request_id::RequestId
    for crate::operation::get_task_assist_code_generation::GetTaskAssistCodeGenerationError
{
...
pub use crate::operation::get_task_assist_code_generation::_get_task_assist_code_generation_input::GetTaskAssistCodeGenerationInput;
pub use crate::operation::get_task_assist_code_generation::_get_task_assist_code_generation_output::GetTaskAssistCodeGenerationOutput;

mod _get_task_assist_code_generation_input;

mod _get_task_assist_code_generation_output;
