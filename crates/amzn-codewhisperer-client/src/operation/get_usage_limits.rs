...
/// Orchestration and serialization glue logic for `GetUsageLimits`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetUsageLimits;
impl GetUsageLimits {
    /// Creates a new `GetUsageLimits`
    pub fn new() -> Self {
        Self
    }
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_usage_limits::GetUsageLimitsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_usage_limits::GetUsageLimitsOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetUsageLimits {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetUsageLimits");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetUsageLimitsRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                GetUsageLimitsResponseDeserializer,
            ),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(GetUsageLimitsEndpointParamsInterceptor)
...
#[derive(Debug)]
struct GetUsageLimitsResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetUsageLimitsResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_usage_limits::de_get_usage_limits_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_get_usage_limits::de_get_usage_limits_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct GetUsageLimitsRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetUsageLimitsRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::get_usage_limits::GetUsageLimitsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::get_usage_limits::GetUsageLimitsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_usage_limits::ser_get_usage_limits_input(&input)?,
        );
...
#[derive(Debug)]
struct GetUsageLimitsEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetUsageLimitsEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "GetUsageLimitsEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<GetUsageLimitsInput>()
            .ok_or("failed to downcast to GetUsageLimitsInput")?;
...
/// Error type for the `GetUsageLimitsError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum GetUsageLimitsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetUsageLimitsError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl GetUsageLimitsError {
    /// Creates the `GetUsageLimitsError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `GetUsageLimitsError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `GetUsageLimitsError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `GetUsageLimitsError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `GetUsageLimitsError::ThrottlingError`.
    pub fn is_throttling_error(&self) -> bool {
        matches!(self, Self::ThrottlingError(_))
    }

    /// Returns `true` if the error kind is `GetUsageLimitsError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }
}
impl ::std::error::Error for GetUsageLimitsError {
...
impl ::std::fmt::Display for GetUsageLimitsError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for GetUsageLimitsError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetUsageLimitsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetUsageLimitsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_usage_limits::GetUsageLimitsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use crate::operation::get_usage_limits::_get_usage_limits_input::GetUsageLimitsInput;
pub use crate::operation::get_usage_limits::_get_usage_limits_output::GetUsageLimitsOutput;

mod _get_usage_limits_input;

mod _get_usage_limits_output;
