...
/// Paginator for
/// [`ListAvailableModels`](crate::operation::list_available_models::ListAvailableModels)
pub struct ListAvailableModelsPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::list_available_models::builders::ListAvailableModelsInputBuilder,
    stop_on_duplicate_token: bool,
}

impl ListAvailableModelsPaginator {
    ...
    ///
    /// This paginator automatically flattens results using `models`. Queries to the underlying
    /// service are dispatched lazily.
    pub fn items(self) -> crate::operation::list_available_models::paginator::ListAvailableModelsPaginatorItems {
        crate::operation::list_available_models::paginator::ListAvailableModelsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(
            ::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_available_models::ListAvailableModels::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token =
                                    crate::lens::reflens_list_available_models_output_output_next_token(resp);
...
/// Flattened paginator for `ListAvailableModelsPaginator`
///
/// This is created with [`.items()`](ListAvailableModelsPaginator::items)
pub struct ListAvailableModelsPaginatorItems(ListAvailableModelsPaginator);

impl ListAvailableModelsPaginatorItems {
    /// Create the pagination stream
    ///
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_available_models_output_output_models(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
