...
/// Orchestration and serialization glue logic for `ListAvailableProfiles`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ListAvailableProfiles;
impl ListAvailableProfiles {
    /// Creates a new `ListAvailableProfiles`
    pub fn new() -> Self {
        Self
    }
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_available_profiles::ListAvailableProfilesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_available_profiles::ListAvailableProfilesOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListAvailableProfiles {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListAvailableProfiles");
...
#[derive(Debug)]
struct ListAvailableProfilesResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAvailableProfilesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListAvailableProfilesRequestSerializer {
    ...
    > {
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::list_available_profiles::ListAvailableProfilesInput,
...
#[derive(Debug)]
struct ListAvailableProfilesEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListAvailableProfilesEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "ListAvailableProfilesEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<ListAvailableProfilesInput>()
...
/// Error type for the `ListAvailableProfilesError` operation.
#[non_exhaustive]
...
impl ::std::error::Error for ListAvailableProfilesError {
...
impl ::std::fmt::Display for ListAvailableProfilesError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for ListAvailableProfilesError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListAvailableProfilesError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListAvailableProfilesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_available_profiles::ListAvailableProfilesError {
...
mod _list_available_profiles_output;
