...
/// Paginator for
/// [`ListAvailableProfiles`](crate::operation::list_available_profiles::ListAvailableProfiles)
pub struct ListAvailableProfilesPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::list_available_profiles::builders::ListAvailableProfilesInputBuilder,
    stop_on_duplicate_token: bool,
}

impl ListAvailableProfilesPaginator {
    ...
    pub fn items(self) -> crate::operation::list_available_profiles::paginator::ListAvailableProfilesPaginatorItems {
        crate::operation::list_available_profiles::paginator::ListAvailableProfilesPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(
            ::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_available_profiles::ListAvailableProfiles::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token =
                                    crate::lens::reflens_list_available_profiles_output_output_next_token(resp);
...
/// Flattened paginator for `ListAvailableProfilesPaginator`
///
/// This is created with [`.items()`](ListAvailableProfilesPaginator::items)
pub struct ListAvailableProfilesPaginatorItems(ListAvailableProfilesPaginator);

impl ListAvailableProfilesPaginatorItems {
    /// Create the pagination stream
    ///
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_available_profiles_output_output_profiles(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
