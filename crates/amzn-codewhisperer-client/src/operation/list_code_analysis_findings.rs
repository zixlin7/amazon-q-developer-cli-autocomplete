...
/// Orchestration and serialization glue logic for `ListCodeAnalysisFindings`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ListCodeAnalysisFindings;
impl ListCodeAnalysisFindings {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_code_analysis_findings::ListCodeAnalysisFindingsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_code_analysis_findings::ListCodeAnalysisFindingsOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListCodeAnalysisFindings {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListCodeAnalysisFindings");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListCodeAnalysisFindingsRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                ListCodeAnalysisFindingsResponseDeserializer,
            ),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(ListCodeAnalysisFindingsEndpointParamsInterceptor)
...
#[derive(Debug)]
struct ListCodeAnalysisFindingsResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListCodeAnalysisFindingsResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_code_analysis_findings::de_list_code_analysis_findings_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_code_analysis_findings::de_list_code_analysis_findings_http_response(
                status, headers, body,
            )
        };
...
#[derive(Debug)]
struct ListCodeAnalysisFindingsRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListCodeAnalysisFindingsRequestSerializer {
    #[allow(
        unused_mut,
...
#[derive(Debug)]
struct ListCodeAnalysisFindingsEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListCodeAnalysisFindingsEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "ListCodeAnalysisFindingsEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<ListCodeAnalysisFindingsInput>()
            .ok_or("failed to downcast to ListCodeAnalysisFindingsInput")?;
...
/// Error type for the `ListCodeAnalysisFindingsError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum ListCodeAnalysisFindingsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListCodeAnalysisFindingsError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl ListCodeAnalysisFindingsError {
    /// Creates the `ListCodeAnalysisFindingsError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `ListCodeAnalysisFindingsError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `ListCodeAnalysisFindingsError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is `ListCodeAnalysisFindingsError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `ListCodeAnalysisFindingsError::ResourceNotFoundError`.
    pub fn is_resource_not_found_error(&self) -> bool {
        matches!(self, Self::ResourceNotFoundError(_))
    }

    /// Returns `true` if the error kind is `ListCodeAnalysisFindingsError::ThrottlingError`.
    pub fn is_throttling_error(&self) -> bool {
        matches!(self, Self::ThrottlingError(_))
    }

    /// Returns `true` if the error kind is `ListCodeAnalysisFindingsError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }
}
impl ::std::error::Error for ListCodeAnalysisFindingsError {
...
impl ::std::fmt::Display for ListCodeAnalysisFindingsError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for ListCodeAnalysisFindingsError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListCodeAnalysisFindingsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListCodeAnalysisFindingsError {
...
impl ::aws_types::request_id::RequestId
    for crate::operation::list_code_analysis_findings::ListCodeAnalysisFindingsError
{
...
pub use crate::operation::list_code_analysis_findings::_list_code_analysis_findings_input::ListCodeAnalysisFindingsInput;
pub use crate::operation::list_code_analysis_findings::_list_code_analysis_findings_output::ListCodeAnalysisFindingsOutput;

mod _list_code_analysis_findings_input;

mod _list_code_analysis_findings_output;
