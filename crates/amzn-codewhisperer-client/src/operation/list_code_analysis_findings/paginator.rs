...
/// Paginator for
/// [`ListCodeAnalysisFindings`](crate::operation::list_code_analysis_findings::ListCodeAnalysisFindings)
pub struct ListCodeAnalysisFindingsPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::list_code_analysis_findings::builders::ListCodeAnalysisFindingsInputBuilder,
    stop_on_duplicate_token: bool,
}

impl ListCodeAnalysisFindingsPaginator {
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(
            ::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            crate::operation::list_code_analysis_findings::ListCodeAnalysisFindings::orchestrate(
                                &runtime_plugins,
                                input.clone(),
                            )
                            .await;
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token =
                                    crate::lens::reflens_list_code_analysis_findings_output_output_next_token(resp);
