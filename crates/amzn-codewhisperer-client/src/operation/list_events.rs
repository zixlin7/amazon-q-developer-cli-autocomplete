...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListEvents {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListEventsResponseDeserializer),
        );
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListEventsRequestSerializer {
    ...
    > {
        let input = input
            .downcast::<crate::operation::list_events::ListEventsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonCodeWhispererService.ListEvents",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_list_events::ser_list_events_input(&input)?,
        );
...
impl ListEventsError {
    ...
    /// Creates the `ListEventsError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `ListEventsError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `ListEventsError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `ListEventsError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is `ListEventsError::ThrottlingError`.
