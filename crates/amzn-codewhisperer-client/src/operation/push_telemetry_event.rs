...
/// Orchestration and serialization glue logic for `PushTelemetryEvent`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct PushTelemetryEvent;
impl PushTelemetryEvent {
    /// Creates a new `PushTelemetryEvent`
    pub fn new() -> Self {
        Self
    }
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::push_telemetry_event::PushTelemetryEventError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::push_telemetry_event::PushTelemetryEventOutput>()
        ...
        runtime_plugins = runtime_plugins
            .with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
                |token_provider, input| {
                    let input: &mut crate::operation::push_telemetry_event::PushTelemetryEventInput =
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PushTelemetryEvent {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PushTelemetryEvent");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            PushTelemetryEventRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                PushTelemetryEventResponseDeserializer,
            ),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(PushTelemetryEventEndpointParamsInterceptor)
...
#[derive(Debug)]
struct PushTelemetryEventResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PushTelemetryEventResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_push_telemetry_event::de_push_telemetry_event_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_push_telemetry_event::de_push_telemetry_event_http_response(
                status, headers, body,
            )
        };
...
#[derive(Debug)]
struct PushTelemetryEventRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PushTelemetryEventRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::push_telemetry_event::PushTelemetryEventInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::push_telemetry_event::PushTelemetryEventInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonCodeWhispererService.PushTelemetryEvent",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_push_telemetry_event::ser_push_telemetry_event_input(&input)?,
        );
...
#[derive(Debug)]
struct PushTelemetryEventEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PushTelemetryEventEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "PushTelemetryEventEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<PushTelemetryEventInput>()
            .ok_or("failed to downcast to PushTelemetryEventInput")?;
...
/// Error type for the `PushTelemetryEventError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum PushTelemetryEventError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PushTelemetryEventError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl PushTelemetryEventError {
    /// Creates the `PushTelemetryEventError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `PushTelemetryEventError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `PushTelemetryEventError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `PushTelemetryEventError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `PushTelemetryEventError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is `PushTelemetryEventError::ThrottlingError`.
    pub fn is_throttling_error(&self) -> bool {
        matches!(self, Self::ThrottlingError(_))
    }
}
impl ::std::error::Error for PushTelemetryEventError {
...
impl ::std::fmt::Display for PushTelemetryEventError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for PushTelemetryEventError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for PushTelemetryEventError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PushTelemetryEventError {
...
impl ::aws_types::request_id::RequestId for crate::operation::push_telemetry_event::PushTelemetryEventError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use crate::operation::push_telemetry_event::_push_telemetry_event_input::PushTelemetryEventInput;
pub use crate::operation::push_telemetry_event::_push_telemetry_event_output::PushTelemetryEventOutput;

mod _push_telemetry_event_input;

mod _push_telemetry_event_output;
