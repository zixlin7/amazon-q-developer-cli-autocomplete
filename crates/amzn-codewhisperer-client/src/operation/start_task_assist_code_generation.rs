...
/// Orchestration and serialization glue logic for `StartTaskAssistCodeGeneration`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct StartTaskAssistCodeGeneration;
impl StartTaskAssistCodeGeneration {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::start_task_assist_code_generation::StartTaskAssistCodeGenerationError>(
                )
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::start_task_assist_code_generation::StartTaskAssistCodeGenerationOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartTaskAssistCodeGeneration {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartTaskAssistCodeGeneration");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            StartTaskAssistCodeGenerationRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                StartTaskAssistCodeGenerationResponseDeserializer,
            ),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(StartTaskAssistCodeGenerationEndpointParamsInterceptor)
...
#[derive(Debug)]
struct StartTaskAssistCodeGenerationResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for StartTaskAssistCodeGenerationResponseDeserializer
{
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_start_task_assist_code_generation::de_start_task_assist_code_generation_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_start_task_assist_code_generation::de_start_task_assist_code_generation_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct StartTaskAssistCodeGenerationRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartTaskAssistCodeGenerationRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::start_task_assist_code_generation::StartTaskAssistCodeGenerationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::start_task_assist_code_generation::StartTaskAssistCodeGenerationInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonCodeWhispererService.StartTaskAssistCodeGeneration",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_start_task_assist_code_generation::ser_start_task_assist_code_generation_input(&input)?,
        );
...
#[derive(Debug)]
struct StartTaskAssistCodeGenerationEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for StartTaskAssistCodeGenerationEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "StartTaskAssistCodeGenerationEndpointParamsInterceptor"
    }
...
/// Error type for the `StartTaskAssistCodeGenerationError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum StartTaskAssistCodeGenerationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartTaskAssistCodeGenerationError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl StartTaskAssistCodeGenerationError {
    /// Creates the `StartTaskAssistCodeGenerationError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `StartTaskAssistCodeGenerationError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is
    /// `StartTaskAssistCodeGenerationError::ServiceQuotaExceededError`.
    pub fn is_service_quota_exceeded_error(&self) -> bool {
        matches!(self, Self::ServiceQuotaExceededError(_))
    }

    /// Returns `true` if the error kind is `StartTaskAssistCodeGenerationError::ThrottlingError`.
...
impl ::std::error::Error for StartTaskAssistCodeGenerationError {
...
impl ::std::fmt::Display for StartTaskAssistCodeGenerationError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for StartTaskAssistCodeGenerationError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for StartTaskAssistCodeGenerationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartTaskAssistCodeGenerationError {
...
impl ::aws_types::request_id::RequestId
    for crate::operation::start_task_assist_code_generation::StartTaskAssistCodeGenerationError
{
...
pub use crate::operation::start_task_assist_code_generation::_start_task_assist_code_generation_input::StartTaskAssistCodeGenerationInput;
pub use crate::operation::start_task_assist_code_generation::_start_task_assist_code_generation_output::StartTaskAssistCodeGenerationOutput;

mod _start_task_assist_code_generation_input;

mod _start_task_assist_code_generation_output;
