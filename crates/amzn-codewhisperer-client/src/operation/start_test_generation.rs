...
/// Orchestration and serialization glue logic for `StartTestGeneration`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct StartTestGeneration;
impl StartTestGeneration {
    /// Creates a new `StartTestGeneration`
    pub fn new() -> Self {
        Self
    }
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::start_test_generation::StartTestGenerationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::start_test_generation::StartTestGenerationOutput>()
        ...
        runtime_plugins = runtime_plugins
            .with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
                |token_provider, input| {
                    let input: &mut crate::operation::start_test_generation::StartTestGenerationInput =
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartTestGeneration {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartTestGeneration");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            StartTestGenerationRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                StartTestGenerationResponseDeserializer,
            ),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(StartTestGenerationEndpointParamsInterceptor)
...
#[derive(Debug)]
struct StartTestGenerationResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartTestGenerationResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_start_test_generation::de_start_test_generation_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_start_test_generation::de_start_test_generation_http_response(
                status, headers, body,
            )
        };
...
#[derive(Debug)]
struct StartTestGenerationRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartTestGenerationRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::start_test_generation::StartTestGenerationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::start_test_generation::StartTestGenerationInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonCodeWhispererService.StartTestGeneration",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_start_test_generation::ser_start_test_generation_input(&input)?,
        );
...
#[derive(Debug)]
struct StartTestGenerationEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartTestGenerationEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "StartTestGenerationEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<StartTestGenerationInput>()
            .ok_or("failed to downcast to StartTestGenerationInput")?;
...
/// Error type for the `StartTestGenerationError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum StartTestGenerationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartTestGenerationError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl StartTestGenerationError {
    /// Creates the `StartTestGenerationError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `StartTestGenerationError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `StartTestGenerationError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `StartTestGenerationError::ConflictError`.
    pub fn is_conflict_error(&self) -> bool {
        matches!(self, Self::ConflictError(_))
    }

    /// Returns `true` if the error kind is `StartTestGenerationError::ThrottlingError`.
    pub fn is_throttling_error(&self) -> bool {
        matches!(self, Self::ThrottlingError(_))
    }

    /// Returns `true` if the error kind is `StartTestGenerationError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `StartTestGenerationError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }
}
impl ::std::error::Error for StartTestGenerationError {
...
impl ::std::fmt::Display for StartTestGenerationError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for StartTestGenerationError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for StartTestGenerationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartTestGenerationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_test_generation::StartTestGenerationError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use crate::operation::start_test_generation::_start_test_generation_input::StartTestGenerationInput;
pub use crate::operation::start_test_generation::_start_test_generation_output::StartTestGenerationOutput;

mod _start_test_generation_input;

mod _start_test_generation_output;
