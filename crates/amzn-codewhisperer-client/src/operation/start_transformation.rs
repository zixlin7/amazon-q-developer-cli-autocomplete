...
/// Orchestration and serialization glue logic for `StartTransformation`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct StartTransformation;
impl StartTransformation {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::start_transformation::StartTransformationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::start_transformation::StartTransformationOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartTransformation {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartTransformation");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            StartTransformationRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                StartTransformationResponseDeserializer,
            ),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(StartTransformationEndpointParamsInterceptor)
...
#[derive(Debug)]
struct StartTransformationResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartTransformationResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_start_transformation::de_start_transformation_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_start_transformation::de_start_transformation_http_response(
                status, headers, body,
            )
        };
...
#[derive(Debug)]
struct StartTransformationRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartTransformationRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::start_transformation::StartTransformationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::start_transformation::StartTransformationInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonCodeWhispererService.StartTransformation",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_start_transformation::ser_start_transformation_input(&input)?,
        );
...
#[derive(Debug)]
struct StartTransformationEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartTransformationEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "StartTransformationEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<StartTransformationInput>()
            .ok_or("failed to downcast to StartTransformationInput")?;
...
/// Error type for the `StartTransformationError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum StartTransformationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartTransformationError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl StartTransformationError {
    /// Creates the `StartTransformationError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `StartTransformationError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `StartTransformationError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is `StartTransformationError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `StartTransformationError::ThrottlingError`.
    pub fn is_throttling_error(&self) -> bool {
        matches!(self, Self::ThrottlingError(_))
    }

    /// Returns `true` if the error kind is `StartTransformationError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `StartTransformationError::ConflictError`.
    pub fn is_conflict_error(&self) -> bool {
        matches!(self, Self::ConflictError(_))
    }
}
impl ::std::error::Error for StartTransformationError {
...
impl ::std::fmt::Display for StartTransformationError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for StartTransformationError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for StartTransformationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartTransformationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_transformation::StartTransformationError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use crate::operation::start_transformation::_start_transformation_input::StartTransformationInput;
pub use crate::operation::start_transformation::_start_transformation_output::StartTransformationOutput;

mod _start_transformation_input;

mod _start_transformation_output;
