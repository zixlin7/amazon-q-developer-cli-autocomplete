...
/// Orchestration and serialization glue logic for `StopTransformation`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct StopTransformation;
impl StopTransformation {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::stop_transformation::StopTransformationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::stop_transformation::StopTransformationOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StopTransformation {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StopTransformation");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            StopTransformationRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                StopTransformationResponseDeserializer,
            ),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(StopTransformationEndpointParamsInterceptor)
...
#[derive(Debug)]
struct StopTransformationResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StopTransformationResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_stop_transformation::de_stop_transformation_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_stop_transformation::de_stop_transformation_http_response(
                status, headers, body,
            )
        };
...
#[derive(Debug)]
struct StopTransformationRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StopTransformationRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::stop_transformation::StopTransformationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::stop_transformation::StopTransformationInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonCodeWhispererService.StopTransformation",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_stop_transformation::ser_stop_transformation_input(&input)?,
        );
...
#[derive(Debug)]
struct StopTransformationEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StopTransformationEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "StopTransformationEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<StopTransformationInput>()
            .ok_or("failed to downcast to StopTransformationInput")?;
...
/// Error type for the `StopTransformationError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum StopTransformationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StopTransformationError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl StopTransformationError {
    /// Creates the `StopTransformationError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `StopTransformationError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `StopTransformationError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is `StopTransformationError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `StopTransformationError::ThrottlingError`.
    pub fn is_throttling_error(&self) -> bool {
        matches!(self, Self::ThrottlingError(_))
    }

    /// Returns `true` if the error kind is `StopTransformationError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `StopTransformationError::ResourceNotFoundError`.
    pub fn is_resource_not_found_error(&self) -> bool {
        matches!(self, Self::ResourceNotFoundError(_))
    }
}
impl ::std::error::Error for StopTransformationError {
...
impl ::std::fmt::Display for StopTransformationError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for StopTransformationError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for StopTransformationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StopTransformationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::stop_transformation::StopTransformationError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use crate::operation::stop_transformation::_stop_transformation_input::StopTransformationInput;
pub use crate::operation::stop_transformation::_stop_transformation_output::StopTransformationOutput;

mod _stop_transformation_input;

mod _stop_transformation_output;
