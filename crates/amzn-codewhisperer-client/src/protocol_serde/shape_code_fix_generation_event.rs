...
pub fn ser_code_fix_generation_event(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::CodeFixGenerationEvent,
    ...
    if let Some(var_6) = &input.lines_of_code_generated {
        object.key("linesOfCodeGenerated").number(
            #[allow(clippy::useless_conversion)]
            ::aws_smithy_types::Number::NegInt((*var_6).into()),
        );
    }
    if let Some(var_7) = &input.chars_of_code_generated {
