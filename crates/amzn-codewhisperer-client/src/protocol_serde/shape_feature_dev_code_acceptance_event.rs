...
pub fn ser_feature_dev_code_acceptance_event(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::FeatureDevCodeAcceptanceEvent,
    ...
    }
    {
        object.key("linesOfCodeAccepted").number(
            ...
            ::aws_smithy_types::Number::NegInt((input.lines_of_code_accepted).into()),
        );
    }
    {
        object.key("charactersOfCodeAccepted").number(
            #[allow(clippy::useless_conversion)]
            ::aws_smithy_types::Number::NegInt((input.characters_of_code_accepted).into()),
        );
    }
