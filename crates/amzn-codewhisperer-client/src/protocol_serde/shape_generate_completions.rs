...
pub fn de_generate_completions_http_error(
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(crate::operation::generate_completions::GenerateCompletionsError::unhandled(generic)),
    };
    ...
    Err(match error_code {
        ...
        "AccessDeniedException" => {
            crate::operation::generate_completions::GenerateCompletionsError::AccessDeniedError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_generate_completions_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::generate_completions::builders::GenerateCompletionsOutputBuilder::default();
        output = crate::protocol_serde::shape_generate_completions::de_generate_completions(_response_body, output)
            .map_err(crate::operation::generate_completions::GenerateCompletionsError::unhandled)?;
