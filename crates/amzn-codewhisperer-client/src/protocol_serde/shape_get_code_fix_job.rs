...
pub fn de_get_code_fix_job_http_error(
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::get_code_fix_job::GetCodeFixJobError::unhandled(
                generic,
            ));
        },
    };
    ...
    Err(match error_code {
        ...
        "ValidationException" => crate::operation::get_code_fix_job::GetCodeFixJobError::ValidationError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => crate::operation::get_code_fix_job::GetCodeFixJobError::generic(generic),
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_get_code_fix_job_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::get_code_fix_job::builders::GetCodeFixJobOutputBuilder::default();
        output = crate::protocol_serde::shape_get_code_fix_job::de_get_code_fix_job(_response_body, output)
            .map_err(crate::operation::get_code_fix_job::GetCodeFixJobError::unhandled)?;
