...
pub fn de_list_workspace_metadata_http_error(
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(crate::operation::list_workspace_metadata::ListWorkspaceMetadataError::unhandled(generic)),
    };
    ...
    Err(match error_code {
        ...
        "ThrottlingException" => {
            crate::operation::list_workspace_metadata::ListWorkspaceMetadataError::ThrottlingError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_workspace_metadata_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_list_workspace_metadata::de_list_workspace_metadata(_response_body, output)
                .map_err(crate::operation::list_workspace_metadata::ListWorkspaceMetadataError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::list_workspace_metadata_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_workspace_metadata::ListWorkspaceMetadataError::unhandled)?
    })
}
