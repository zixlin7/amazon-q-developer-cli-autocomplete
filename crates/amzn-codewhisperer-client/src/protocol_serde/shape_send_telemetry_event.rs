...
pub fn de_send_telemetry_event_http_error(
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(crate::operation::send_telemetry_event::SendTelemetryEventError::unhandled(generic)),
    };
    ...
    Err(match error_code {
        ...
        "ThrottlingException" => crate::operation::send_telemetry_event::SendTelemetryEventError::ThrottlingError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_send_telemetry_event_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::send_telemetry_event::builders::SendTelemetryEventOutputBuilder::default();
