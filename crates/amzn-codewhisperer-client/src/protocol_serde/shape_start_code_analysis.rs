...
pub fn de_start_code_analysis_http_error(
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(crate::operation::start_code_analysis::StartCodeAnalysisError::unhandled(generic)),
    };
    ...
    Err(match error_code {
        ...
        "ValidationException" => crate::operation::start_code_analysis::StartCodeAnalysisError::ValidationError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_start_code_analysis_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_start_code_analysis::de_start_code_analysis(_response_body, output)
            .map_err(crate::operation::start_code_analysis::StartCodeAnalysisError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::start_code_analysis_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::start_code_analysis::StartCodeAnalysisError::unhandled)?
    })
}
