...
pub fn de_start_test_generation_http_error(
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(crate::operation::start_test_generation::StartTestGenerationError::unhandled(generic)),
    };
    ...
    Err(match error_code {
        ...
        "ValidationException" => crate::operation::start_test_generation::StartTestGenerationError::ValidationError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => crate::operation::start_test_generation::StartTestGenerationError::generic(generic),
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_start_test_generation_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::start_test_generation::builders::StartTestGenerationOutputBuilder::default();
        output = crate::protocol_serde::shape_start_test_generation::de_start_test_generation(_response_body, output)
            .map_err(crate::operation::start_test_generation::StartTestGenerationError::unhandled)?;
