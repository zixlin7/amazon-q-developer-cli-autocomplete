...
pub struct DocGenerationEvent {
    ...
    #[allow(missing_docs)] // documentation missing in model
    pub user_decision: ::std::option::Option<crate::types::DocGenerationUserDecision>,
    /// Doc Generation Interaction Type
    pub interaction_type: ::std::option::Option<crate::types::DocGenerationInteractionType>,
    #[allow(missing_docs)] // documentation missing in model
    pub user_identity: ::std::option::Option<::std::string::String>,
    #[allow(missing_docs)] // documentation missing in model
    pub number_of_navigation: i32,
    /// Doc Generation Folder Level
    pub folder_level: ::std::option::Option<crate::types::DocGenerationFolderLevel>,
}
impl DocGenerationEvent {
    ...
    #[allow(missing_docs)] // documentation missing in model
    pub fn user_decision(&self) -> ::std::option::Option<&crate::types::DocGenerationUserDecision> {
        self.user_decision.as_ref()
    }

    /// Doc Generation Interaction Type
    pub fn interaction_type(&self) -> ::std::option::Option<&crate::types::DocGenerationInteractionType> {
    ...
    /// Doc Generation Folder Level
    pub fn folder_level(&self) -> ::std::option::Option<&crate::types::DocGenerationFolderLevel> {
...
pub struct DocGenerationEventBuilder {
    ...
    pub(crate) user_decision: ::std::option::Option<crate::types::DocGenerationUserDecision>,
    pub(crate) interaction_type: ::std::option::Option<crate::types::DocGenerationInteractionType>,
    pub(crate) user_identity: ::std::option::Option<::std::string::String>,
    pub(crate) number_of_navigation: ::std::option::Option<i32>,
    pub(crate) folder_level: ::std::option::Option<crate::types::DocGenerationFolderLevel>,
}
impl DocGenerationEventBuilder {
    ...
    #[allow(missing_docs)] // documentation missing in model
    pub fn user_decision(mut self, input: crate::types::DocGenerationUserDecision) -> Self {
        self.user_decision = ::std::option::Option::Some(input);
        self
    }

    #[allow(missing_docs)] // documentation missing in model
    pub fn set_user_decision(mut self, input: ::std::option::Option<crate::types::DocGenerationUserDecision>) -> Self {
        self.user_decision = input;
        self
    }

    #[allow(missing_docs)] // documentation missing in model
    pub fn get_user_decision(&self) -> &::std::option::Option<crate::types::DocGenerationUserDecision> {
        &self.user_decision
    }

    /// Doc Generation Interaction Type
    pub fn interaction_type(mut self, input: crate::types::DocGenerationInteractionType) -> Self {
    ...
    pub fn set_interaction_type(
        mut self,
        input: ::std::option::Option<crate::types::DocGenerationInteractionType>,
    ) -> Self {
    ...
    /// Doc Generation Interaction Type
    pub fn get_interaction_type(&self) -> &::std::option::Option<crate::types::DocGenerationInteractionType> {
    ...
    /// Doc Generation Folder Level
    pub fn folder_level(mut self, input: crate::types::DocGenerationFolderLevel) -> Self {
        self.folder_level = ::std::option::Option::Some(input);
        self
    }

    /// Doc Generation Folder Level
    pub fn set_folder_level(mut self, input: ::std::option::Option<crate::types::DocGenerationFolderLevel>) -> Self {
        self.folder_level = input;
        self
    }

    /// Doc Generation Folder Level
    pub fn get_folder_level(&self) -> &::std::option::Option<crate::types::DocGenerationFolderLevel> {
        &self.folder_level
    }
