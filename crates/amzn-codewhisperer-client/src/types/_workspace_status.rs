...
impl ::std::convert::From<&str> for WorkspaceStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => WorkspaceStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(
                other.to_owned(),
            )),
        }
    }
...
impl WorkspaceStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            WorkspaceStatus::Connected => "CONNECTED",
    ...
    pub const fn values() -> &'static [&'static str] {
        &["CONNECTED", "CREATED", "DELETING", "PENDING", "READY"]
    }
}
...
impl ::std::fmt::Display for WorkspaceStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            WorkspaceStatus::Connected => write!(f, "CONNECTED"),
            WorkspaceStatus::Created => write!(f, "CREATED"),
