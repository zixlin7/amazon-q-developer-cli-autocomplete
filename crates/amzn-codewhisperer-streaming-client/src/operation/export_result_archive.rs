...
/// Orchestration and serialization glue logic for `ExportResultArchive`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ExportResultArchive;
impl ExportResultArchive {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::export_result_archive::ExportResultArchiveError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::export_result_archive::ExportResultArchiveOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ExportResultArchive {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ExportResultArchive");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ExportResultArchiveRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                ExportResultArchiveResponseDeserializer,
            ),
        );
...
#[derive(Debug)]
struct ExportResultArchiveResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ExportResultArchiveResponseDeserializer {
    fn deserialize_streaming(
        ...
        ::std::option::Option::Some(crate::protocol_serde::type_erase_result(
            crate::protocol_serde::shape_export_result_archive::de_export_result_archive_http_response(response),
        ))
    }
    ...
    fn deserialize_nonstreaming(
        ...
        crate::protocol_serde::type_erase_result(
            crate::protocol_serde::shape_export_result_archive::de_export_result_archive_http_error(
...
#[derive(Debug)]
struct ExportResultArchiveRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ExportResultArchiveRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::export_result_archive::ExportResultArchiveInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::export_result_archive::ExportResultArchiveInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonCodeWhispererStreamingService.ExportResultArchive",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_export_result_archive::ser_export_result_archive_input(&input)?,
        );
...
#[derive(Debug)]
struct ExportResultArchiveEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ExportResultArchiveEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "ExportResultArchiveEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<ExportResultArchiveInput>()
            .ok_or("failed to downcast to ExportResultArchiveInput")?;
...
/// Error type for the `ExportResultArchiveError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum ExportResultArchiveError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ExportResultArchiveError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl ExportResultArchiveError {
    /// Creates the `ExportResultArchiveError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `ExportResultArchiveError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `ExportResultArchiveError::ThrottlingError`.
    pub fn is_throttling_error(&self) -> bool {
        matches!(self, Self::ThrottlingError(_))
    }

    /// Returns `true` if the error kind is `ExportResultArchiveError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `ExportResultArchiveError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `ExportResultArchiveError::ConflictError`.
    pub fn is_conflict_error(&self) -> bool {
        matches!(self, Self::ConflictError(_))
    }

    /// Returns `true` if the error kind is `ExportResultArchiveError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is `ExportResultArchiveError::ResourceNotFoundError`.
    pub fn is_resource_not_found_error(&self) -> bool {
        matches!(self, Self::ResourceNotFoundError(_))
    }
}
impl ::std::error::Error for ExportResultArchiveError {
...
impl ::std::fmt::Display for ExportResultArchiveError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for ExportResultArchiveError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ExportResultArchiveError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ExportResultArchiveError {
...
impl ::aws_types::request_id::RequestId for crate::operation::export_result_archive::ExportResultArchiveError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use crate::operation::export_result_archive::_export_result_archive_input::ExportResultArchiveInput;
pub use crate::operation::export_result_archive::_export_result_archive_output::ExportResultArchiveOutput;

mod _export_result_archive_input;

mod _export_result_archive_output;
