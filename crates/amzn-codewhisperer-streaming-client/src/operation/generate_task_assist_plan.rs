...
/// Orchestration and serialization glue logic for `GenerateTaskAssistPlan`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GenerateTaskAssistPlan;
impl GenerateTaskAssistPlan {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::generate_task_assist_plan::GenerateTaskAssistPlanError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::generate_task_assist_plan::GenerateTaskAssistPlanOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GenerateTaskAssistPlan {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GenerateTaskAssistPlan");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GenerateTaskAssistPlanRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                GenerateTaskAssistPlanResponseDeserializer,
            ),
        );
...
#[derive(Debug)]
struct GenerateTaskAssistPlanResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GenerateTaskAssistPlanResponseDeserializer {
    fn deserialize_streaming(
        ...
        ::std::option::Option::Some(crate::protocol_serde::type_erase_result(
            crate::protocol_serde::shape_generate_task_assist_plan::de_generate_task_assist_plan_http_response(
                response,
            ),
        ))
    }
    ...
    fn deserialize_nonstreaming(
        ...
        crate::protocol_serde::type_erase_result(
            crate::protocol_serde::shape_generate_task_assist_plan::de_generate_task_assist_plan_http_error(
...
#[derive(Debug)]
struct GenerateTaskAssistPlanRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GenerateTaskAssistPlanRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::generate_task_assist_plan::GenerateTaskAssistPlanInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::generate_task_assist_plan::GenerateTaskAssistPlanInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonCodeWhispererStreamingService.GenerateTaskAssistPlan",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_generate_task_assist_plan::ser_generate_task_assist_plan_input(&input)?,
        );
...
#[derive(Debug)]
struct GenerateTaskAssistPlanEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GenerateTaskAssistPlanEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "GenerateTaskAssistPlanEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<GenerateTaskAssistPlanInput>()
            .ok_or("failed to downcast to GenerateTaskAssistPlanInput")?;
...
/// Error type for the `GenerateTaskAssistPlanError` operation.
#[non_exhaustive]
...
pub enum GenerateTaskAssistPlanError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GenerateTaskAssistPlanError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl GenerateTaskAssistPlanError {
    /// Creates the `GenerateTaskAssistPlanError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `GenerateTaskAssistPlanError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `GenerateTaskAssistPlanError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `GenerateTaskAssistPlanError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `GenerateTaskAssistPlanError::ConflictError`.
    pub fn is_conflict_error(&self) -> bool {
        matches!(self, Self::ConflictError(_))
    }

    /// Returns `true` if the error kind is `GenerateTaskAssistPlanError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is `GenerateTaskAssistPlanError::ResourceNotFoundError`.
...
impl ::aws_smithy_types::retry::ProvideErrorKind for GenerateTaskAssistPlanError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GenerateTaskAssistPlanError {
...
impl ::aws_types::request_id::RequestId for crate::operation::generate_task_assist_plan::GenerateTaskAssistPlanError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use crate::operation::generate_task_assist_plan::_generate_task_assist_plan_input::GenerateTaskAssistPlanInput;
pub use crate::operation::generate_task_assist_plan::_generate_task_assist_plan_output::GenerateTaskAssistPlanOutput;

mod _generate_task_assist_plan_input;

mod _generate_task_assist_plan_output;
