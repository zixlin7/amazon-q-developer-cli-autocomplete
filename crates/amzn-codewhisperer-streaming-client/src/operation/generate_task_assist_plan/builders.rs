...
pub use crate::operation::generate_task_assist_plan::_generate_task_assist_plan_input::GenerateTaskAssistPlanInputBuilder;
pub use crate::operation::generate_task_assist_plan::_generate_task_assist_plan_output::GenerateTaskAssistPlanOutputBuilder;

impl crate::operation::generate_task_assist_plan::builders::GenerateTaskAssistPlanInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.generate_task_assist_plan();
...
pub struct GenerateTaskAssistPlanFluentBuilder {
    ...
    inner: crate::operation::generate_task_assist_plan::builders::GenerateTaskAssistPlanInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::generate_task_assist_plan::GenerateTaskAssistPlanOutput,
        crate::operation::generate_task_assist_plan::GenerateTaskAssistPlanError,
    > for GenerateTaskAssistPlanFluentBuilder
{
    fn send(
        self,
...
impl GenerateTaskAssistPlanFluentBuilder {
    ...
    /// Access the GenerateTaskAssistPlan as a reference.
    pub fn as_input(
        &self,
    ) -> &crate::operation::generate_task_assist_plan::builders::GenerateTaskAssistPlanInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::generate_task_assist_plan::GenerateTaskAssistPlan::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        crate::operation::generate_task_assist_plan::GenerateTaskAssistPlan::orchestrate(&runtime_plugins, input).await
    }
