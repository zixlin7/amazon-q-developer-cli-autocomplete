...
///     ConflictExceptionReason::CustomerKmsKeyDisabled => { /* ... */ },
///     ConflictExceptionReason::CustomerKmsKeyInvalidKeyPolicy => { /* ... */ },
///     ConflictExceptionReason::MismatchedKmsKey => { /* ... */ },
...
pub enum ConflictExceptionReason {
    ...
    CustomerKmsKeyDisabled,
    #[allow(missing_docs)] // documentation missing in model
    CustomerKmsKeyInvalidKeyPolicy,
    #[allow(missing_docs)] // documentation missing in model
    MismatchedKmsKey,
...
impl ConflictExceptionReason {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ConflictExceptionReason::CustomerKmsKeyDisabled => "CUSTOMER_KMS_KEY_DISABLED",
            ConflictExceptionReason::CustomerKmsKeyInvalidKeyPolicy => "CUSTOMER_KMS_KEY_INVALID_KEY_POLICY",
            ConflictExceptionReason::MismatchedKmsKey => "MISMATCHED_KMS_KEY",
