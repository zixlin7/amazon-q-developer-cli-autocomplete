...
/// Orchestration and serialization glue logic for `AssociateCustomizationPermission`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct AssociateCustomizationPermission;
impl AssociateCustomizationPermission {
    /// Creates a new `AssociateCustomizationPermission`
    pub fn new() -> Self {
        Self
    }
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::associate_customization_permission::AssociateCustomizationPermissionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::associate_customization_permission::AssociateCustomizationPermissionOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssociateCustomizationPermission {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AssociateCustomizationPermission");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AssociateCustomizationPermissionRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                AssociateCustomizationPermissionResponseDeserializer,
            ),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(AssociateCustomizationPermissionEndpointParamsInterceptor)
...
#[derive(Debug)]
struct AssociateCustomizationPermissionResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for AssociateCustomizationPermissionResponseDeserializer
{
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_associate_customization_permission::de_associate_customization_permission_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_associate_customization_permission::de_associate_customization_permission_http_response(
                status, headers, body,
            )
        };
...
#[derive(Debug)]
struct AssociateCustomizationPermissionRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssociateCustomizationPermissionRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::associate_customization_permission::AssociateCustomizationPermissionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::associate_customization_permission::AssociateCustomizationPermissionInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AWSCodeWhispererService.AssociateCustomizationPermission",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_associate_customization_permission::ser_associate_customization_permission_input(&input)?,
        );
...
#[derive(Debug)]
struct AssociateCustomizationPermissionEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for AssociateCustomizationPermissionEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "AssociateCustomizationPermissionEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<AssociateCustomizationPermissionInput>()
            .ok_or("failed to downcast to AssociateCustomizationPermissionInput")?;
...
/// Error type for the `AssociateCustomizationPermissionError` operation.
#[non_exhaustive]
...
pub enum AssociateCustomizationPermissionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AssociateCustomizationPermissionError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl AssociateCustomizationPermissionError {
    /// Creates the `AssociateCustomizationPermissionError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `AssociateCustomizationPermissionError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is
    /// `AssociateCustomizationPermissionError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is
    /// `AssociateCustomizationPermissionError::ThrottlingError`.
    ...
    /// Returns `true` if the error kind is
    /// `AssociateCustomizationPermissionError::ResourceNotFoundError`.
...
impl ::aws_smithy_types::retry::ProvideErrorKind for AssociateCustomizationPermissionError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AssociateCustomizationPermissionError {
...
impl ::aws_types::request_id::RequestId
    for crate::operation::associate_customization_permission::AssociateCustomizationPermissionError
{
...
pub use crate::operation::associate_customization_permission::_associate_customization_permission_input::AssociateCustomizationPermissionInput;
pub use crate::operation::associate_customization_permission::_associate_customization_permission_output::AssociateCustomizationPermissionOutput;

mod _associate_customization_permission_input;

mod _associate_customization_permission_output;
