...
/// Orchestration and serialization glue logic for `DeleteCustomization`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DeleteCustomization;
impl DeleteCustomization {
    /// Creates a new `DeleteCustomization`
    pub fn new() -> Self {
        Self
    }
    ...
    pub(crate) async fn orchestrate(
        ...
        input: crate::operation::delete_customization::DeleteCustomizationInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::delete_customization::DeleteCustomizationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::delete_customization::DeleteCustomizationOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteCustomization {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteCustomization");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DeleteCustomizationRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                DeleteCustomizationResponseDeserializer,
            ),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(DeleteCustomizationEndpointParamsInterceptor)
...
#[derive(Debug)]
struct DeleteCustomizationResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteCustomizationResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_delete_customization::de_delete_customization_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_delete_customization::de_delete_customization_http_response(
                status, headers, body,
            )
        };
...
#[derive(Debug)]
struct DeleteCustomizationRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteCustomizationRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::delete_customization::DeleteCustomizationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::delete_customization::DeleteCustomizationInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AWSCodeWhispererService.DeleteCustomization",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_delete_customization::ser_delete_customization_input(&input)?,
        );
...
#[derive(Debug)]
struct DeleteCustomizationEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteCustomizationEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "DeleteCustomizationEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<DeleteCustomizationInput>()
            .ok_or("failed to downcast to DeleteCustomizationInput")?;
...
/// Error type for the `DeleteCustomizationError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum DeleteCustomizationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteCustomizationError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl DeleteCustomizationError {
    /// Creates the `DeleteCustomizationError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `DeleteCustomizationError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `DeleteCustomizationError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `DeleteCustomizationError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `DeleteCustomizationError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is `DeleteCustomizationError::ResourceNotFoundError`.
    pub fn is_resource_not_found_error(&self) -> bool {
        matches!(self, Self::ResourceNotFoundError(_))
    }

    /// Returns `true` if the error kind is `DeleteCustomizationError::ConflictError`.
    pub fn is_conflict_error(&self) -> bool {
        matches!(self, Self::ConflictError(_))
    }

    /// Returns `true` if the error kind is `DeleteCustomizationError::ThrottlingError`.
    pub fn is_throttling_error(&self) -> bool {
        matches!(self, Self::ThrottlingError(_))
    }
}
impl ::std::error::Error for DeleteCustomizationError {
...
impl ::std::fmt::Display for DeleteCustomizationError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for DeleteCustomizationError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteCustomizationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteCustomizationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_customization::DeleteCustomizationError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use crate::operation::delete_customization::_delete_customization_input::DeleteCustomizationInput;
pub use crate::operation::delete_customization::_delete_customization_output::DeleteCustomizationOutput;

mod _delete_customization_input;

mod _delete_customization_output;
