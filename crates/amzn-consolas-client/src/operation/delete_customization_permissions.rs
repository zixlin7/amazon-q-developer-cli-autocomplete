...
/// Orchestration and serialization glue logic for `DeleteCustomizationPermissions`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DeleteCustomizationPermissions;
impl DeleteCustomizationPermissions {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::delete_customization_permissions::DeleteCustomizationPermissionsError>(
                )
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::delete_customization_permissions::DeleteCustomizationPermissionsOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point(
            "codewhisperer",
            "DeleteCustomizationPermissions",
            input,
            runtime_plugins,
            stop_point,
        )
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteCustomizationPermissions {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteCustomizationPermissions");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DeleteCustomizationPermissionsRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                DeleteCustomizationPermissionsResponseDeserializer,
            ),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(DeleteCustomizationPermissionsEndpointParamsInterceptor)
...
#[derive(Debug)]
struct DeleteCustomizationPermissionsResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for DeleteCustomizationPermissionsResponseDeserializer
{
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_delete_customization_permissions::de_delete_customization_permissions_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_delete_customization_permissions::de_delete_customization_permissions_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct DeleteCustomizationPermissionsRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteCustomizationPermissionsRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::delete_customization_permissions::DeleteCustomizationPermissionsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::delete_customization_permissions::DeleteCustomizationPermissionsInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AWSCodeWhispererService.DeleteCustomizationPermissions",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_delete_customization_permissions::ser_delete_customization_permissions_input(
                &input,
            )?,
        );
...
#[derive(Debug)]
struct DeleteCustomizationPermissionsEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for DeleteCustomizationPermissionsEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "DeleteCustomizationPermissionsEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<DeleteCustomizationPermissionsInput>()
            .ok_or("failed to downcast to DeleteCustomizationPermissionsInput")?;
...
/// Error type for the `DeleteCustomizationPermissionsError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum DeleteCustomizationPermissionsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteCustomizationPermissionsError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl DeleteCustomizationPermissionsError {
    /// Creates the `DeleteCustomizationPermissionsError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `DeleteCustomizationPermissionsError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `DeleteCustomizationPermissionsError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is
    /// `DeleteCustomizationPermissionsError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is
    /// `DeleteCustomizationPermissionsError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is `DeleteCustomizationPermissionsError::ThrottlingError`.
    pub fn is_throttling_error(&self) -> bool {
        matches!(self, Self::ThrottlingError(_))
    }

    /// Returns `true` if the error kind is `DeleteCustomizationPermissionsError::ConflictError`.
    pub fn is_conflict_error(&self) -> bool {
        matches!(self, Self::ConflictError(_))
    }

    /// Returns `true` if the error kind is
    /// `DeleteCustomizationPermissionsError::ResourceNotFoundError`.
    pub fn is_resource_not_found_error(&self) -> bool {
        matches!(self, Self::ResourceNotFoundError(_))
    }
}
impl ::std::error::Error for DeleteCustomizationPermissionsError {
...
impl ::std::fmt::Display for DeleteCustomizationPermissionsError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for DeleteCustomizationPermissionsError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteCustomizationPermissionsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteCustomizationPermissionsError {
...
impl ::aws_types::request_id::RequestId
    for crate::operation::delete_customization_permissions::DeleteCustomizationPermissionsError
{
...
pub use crate::operation::delete_customization_permissions::_delete_customization_permissions_input::DeleteCustomizationPermissionsInput;
pub use crate::operation::delete_customization_permissions::_delete_customization_permissions_output::DeleteCustomizationPermissionsOutput;

mod _delete_customization_permissions_input;

mod _delete_customization_permissions_output;
