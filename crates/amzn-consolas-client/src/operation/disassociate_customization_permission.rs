...
impl DisassociateCustomizationPermission {
    /// Creates a new `DisassociateCustomizationPermission`
    pub fn new() -> Self {
        Self
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisassociateCustomizationPermission {
    ...
    fn runtime_components(
        ...
        .with_interceptor(DisassociateCustomizationPermissionEndpointParamsInterceptor)
...
pub enum DisassociateCustomizationPermissionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DisassociateCustomizationPermissionError) for what information is available for the error."
    )]
...
impl DisassociateCustomizationPermissionError {
    ...
    /// Creates the `DisassociateCustomizationPermissionError::Unhandled` variant from an
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DisassociateCustomizationPermissionError {
