...
/// Orchestration and serialization glue logic for `GenerateRecommendations`.
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::generate_recommendations::GenerateRecommendationsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::generate_recommendations::GenerateRecommendationsOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GenerateRecommendations {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GenerateRecommendations");
    ...
    fn runtime_components(
        ...
        .with_interceptor(GenerateRecommendationsEndpointParamsInterceptor)
...
#[derive(Debug)]
struct GenerateRecommendationsResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GenerateRecommendationsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GenerateRecommendationsRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::generate_recommendations::GenerateRecommendationsInput,
...
#[derive(Debug)]
struct GenerateRecommendationsEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GenerateRecommendationsEndpointParamsInterceptor {
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<GenerateRecommendationsInput>()
...
/// Error type for the `GenerateRecommendationsError` operation.
#[non_exhaustive]
...
pub enum GenerateRecommendationsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GenerateRecommendationsError) for what information is available for the error."
    )]
...
impl GenerateRecommendationsError {
    ...
    /// Creates the `GenerateRecommendationsError::Unhandled` variant from an
...
impl ::std::error::Error for GenerateRecommendationsError {
...
impl ::std::fmt::Display for GenerateRecommendationsError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for GenerateRecommendationsError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GenerateRecommendationsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GenerateRecommendationsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::generate_recommendations::GenerateRecommendationsError {
...
mod _generate_recommendations_output;
