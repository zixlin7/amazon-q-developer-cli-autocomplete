...
/// Paginator for [`ListProfiles`](crate::operation::list_profiles::ListProfiles)
pub struct ListProfilesPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::list_profiles::builders::ListProfilesInputBuilder,
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_profiles_output_output_next_token(resp);
...
impl ListProfilesPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_profiles_output_output_profiles(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
