...
/// Orchestration and serialization glue logic for `LockServiceLinkedRole`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct LockServiceLinkedRole;
impl LockServiceLinkedRole {
    /// Creates a new `LockServiceLinkedRole`
    pub fn new() -> Self {
        Self
    }
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::lock_service_linked_role::LockServiceLinkedRoleError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::lock_service_linked_role::LockServiceLinkedRoleOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for LockServiceLinkedRole {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("LockServiceLinkedRole");
    ...
    fn runtime_components(
        ...
        .with_interceptor(LockServiceLinkedRoleEndpointParamsInterceptor)
...
#[derive(Debug)]
struct LockServiceLinkedRoleResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for LockServiceLinkedRoleResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for LockServiceLinkedRoleRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::lock_service_linked_role::LockServiceLinkedRoleInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AWSCodeWhispererService.LockServiceLinkedRole",
            );
            builder
        };
...
#[derive(Debug)]
struct LockServiceLinkedRoleEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for LockServiceLinkedRoleEndpointParamsInterceptor {
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<LockServiceLinkedRoleInput>()
...
/// Error type for the `LockServiceLinkedRoleError` operation.
#[non_exhaustive]
...
pub enum LockServiceLinkedRoleError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-LockServiceLinkedRoleError) for what information is available for the error."
    )]
...
impl LockServiceLinkedRoleError {
    ...
    /// Creates the `LockServiceLinkedRoleError::Unhandled` variant from an
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::ServiceLinkedRoleLockClientError(e) => {
                ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e)
            },
            Self::ServiceLinkedRoleLockServiceError(e) => {
                ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e)
            },
...
impl ::std::error::Error for LockServiceLinkedRoleError {
...
impl ::std::fmt::Display for LockServiceLinkedRoleError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for LockServiceLinkedRoleError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for LockServiceLinkedRoleError {
...
impl ::aws_types::request_id::RequestId for crate::operation::lock_service_linked_role::LockServiceLinkedRoleError {
...
mod _lock_service_linked_role_output;
