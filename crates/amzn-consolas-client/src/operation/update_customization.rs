...
/// Orchestration and serialization glue logic for `UpdateCustomization`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateCustomization;
impl UpdateCustomization {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::update_customization::UpdateCustomizationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::update_customization::UpdateCustomizationOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateCustomization {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateCustomization");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UpdateCustomizationRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                UpdateCustomizationResponseDeserializer,
            ),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(UpdateCustomizationEndpointParamsInterceptor)
...
#[derive(Debug)]
struct UpdateCustomizationResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateCustomizationResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_update_customization::de_update_customization_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_update_customization::de_update_customization_http_response(
                status, headers, body,
            )
        };
...
#[derive(Debug)]
struct UpdateCustomizationRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateCustomizationRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::update_customization::UpdateCustomizationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::update_customization::UpdateCustomizationInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AWSCodeWhispererService.UpdateCustomization",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_update_customization::ser_update_customization_input(&input)?,
        );
...
#[derive(Debug)]
struct UpdateCustomizationEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateCustomizationEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "UpdateCustomizationEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<UpdateCustomizationInput>()
            .ok_or("failed to downcast to UpdateCustomizationInput")?;
...
/// Error type for the `UpdateCustomizationError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum UpdateCustomizationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateCustomizationError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl UpdateCustomizationError {
    /// Creates the `UpdateCustomizationError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `UpdateCustomizationError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `UpdateCustomizationError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `UpdateCustomizationError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `UpdateCustomizationError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is `UpdateCustomizationError::ThrottlingError`.
    pub fn is_throttling_error(&self) -> bool {
        matches!(self, Self::ThrottlingError(_))
    }

    /// Returns `true` if the error kind is `UpdateCustomizationError::ConflictError`.
    pub fn is_conflict_error(&self) -> bool {
        matches!(self, Self::ConflictError(_))
    }

    /// Returns `true` if the error kind is `UpdateCustomizationError::ResourceNotFoundError`.
    pub fn is_resource_not_found_error(&self) -> bool {
        matches!(self, Self::ResourceNotFoundError(_))
    }
}
impl ::std::error::Error for UpdateCustomizationError {
...
impl ::std::fmt::Display for UpdateCustomizationError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for UpdateCustomizationError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateCustomizationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateCustomizationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_customization::UpdateCustomizationError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use crate::operation::update_customization::_update_customization_input::UpdateCustomizationInput;
pub use crate::operation::update_customization::_update_customization_output::UpdateCustomizationOutput;

mod _update_customization_input;

mod _update_customization_output;
