...
pub fn de_vend_key_grant_http_error(
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(crate::operation::vend_key_grant::VendKeyGrantError::unhandled(generic)),
    };
    ...
    Err(match error_code {
        ...
        "ThrottlingException" => crate::operation::vend_key_grant::VendKeyGrantError::ThrottlingError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => crate::operation::vend_key_grant::VendKeyGrantError::generic(generic),
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_vend_key_grant_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::vend_key_grant::builders::VendKeyGrantOutputBuilder::default();
        output = crate::protocol_serde::shape_vend_key_grant::de_vend_key_grant(_response_body, output)
            .map_err(crate::operation::vend_key_grant::VendKeyGrantError::unhandled)?;
