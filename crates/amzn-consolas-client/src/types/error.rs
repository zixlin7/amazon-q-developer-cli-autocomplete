...
pub use crate::types::error::_service_linked_role_lock_client_exception::ServiceLinkedRoleLockClientError;
pub use crate::types::error::_service_linked_role_lock_service_exception::ServiceLinkedRoleLockServiceError;
...
mod _service_linked_role_lock_service_exception;
