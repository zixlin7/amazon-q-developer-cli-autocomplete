...
/// Configuration for a amzn_qdeveloper_client service client.
///
///
...
impl Builder {
    ...
    /// use std::time::Duration;
    ///
    /// use amzn_qdeveloper_client::config::{
    ///     Builder,
    ///     Config,
    /// };
    /// use aws_smithy_runtime::client::http::hyper_014::HyperClientBuilder;
    ...
    /// }
    ///
    /// let mut builder = amzn_qdeveloper_client::Config::builder();
    ...
    /// ```no_run
    /// use amzn_qdeveloper_client::config::IdentityCache;
    ///
    /// let config = amzn_qdeveloper_client::Config::builder()
    ...
    /// use std::error::Error as StdError;
    /// use std::marker::PhantomData;
    /// use amzn_qdeveloper_client::config::{Builder, Config};
    /// # struct SomeOperationError {}
    ///
    /// const RETRYABLE_ERROR_CODES: &[&str] = [
    ///     // List error codes to be retried here...
    ...
    pub fn build(mut self) -> Config {
        ...
        Config {
            config: crate::config::Layer::from(layer.clone())
                .with_name("amzn_qdeveloper_client::config::Config")
                .freeze(),
            cloneable: layer,
    ...
    pub(crate) fn new(
        ...
        Self {
            config: ::aws_smithy_types::config_bag::Layer::from(layer)
                .with_name("amzn_qdeveloper_client::config::ConfigOverrideRuntimePlugin")
                .freeze(),
            components,
        }
    }
