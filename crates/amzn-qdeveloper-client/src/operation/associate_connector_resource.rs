...
/// Orchestration and serialization glue logic for `AssociateConnectorResource`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct AssociateConnectorResource;
impl AssociateConnectorResource {
    /// Creates a new `AssociateConnectorResource`
    pub fn new() -> Self {
        Self
    }
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::associate_connector_resource::AssociateConnectorResourceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::associate_connector_resource::AssociateConnectorResourceOutput>()
        ...
        runtime_plugins = runtime_plugins
            .with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
                |token_provider, input| {
                    let input: &mut crate::operation::associate_connector_resource::AssociateConnectorResourceInput =
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssociateConnectorResource {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AssociateConnectorResource");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AssociateConnectorResourceRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                AssociateConnectorResourceResponseDeserializer,
            ),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(AssociateConnectorResourceEndpointParamsInterceptor)
...
#[derive(Debug)]
struct AssociateConnectorResourceResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AssociateConnectorResourceResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_associate_connector_resource::de_associate_connector_resource_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_associate_connector_resource::de_associate_connector_resource_http_response(
                status, headers, body,
            )
        };
...
#[derive(Debug)]
struct AssociateConnectorResourceRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssociateConnectorResourceRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::associate_connector_resource::AssociateConnectorResourceInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::associate_connector_resource::AssociateConnectorResourceInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonQDeveloperService.AssociateConnectorResource",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_associate_connector_resource::ser_associate_connector_resource_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AssociateConnectorResourceEndpointParamsInterceptor {
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<AssociateConnectorResourceInput>()
            .ok_or("failed to downcast to AssociateConnectorResourceInput")?;
...
/// Error type for the `AssociateConnectorResourceError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum AssociateConnectorResourceError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AssociateConnectorResourceError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl AssociateConnectorResourceError {
    /// Creates the `AssociateConnectorResourceError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `AssociateConnectorResourceError::Unhandled` variant from an
    ...
    /// `AssociateConnectorResourceError::ResourceNotFoundError`.
    pub fn is_resource_not_found_error(&self) -> bool {
        matches!(self, Self::ResourceNotFoundError(_))
    }

    /// Returns `true` if the error kind is `AssociateConnectorResourceError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is `AssociateConnectorResourceError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `AssociateConnectorResourceError::ConflictError`.
    pub fn is_conflict_error(&self) -> bool {
        matches!(self, Self::ConflictError(_))
    }

    /// Returns `true` if the error kind is `AssociateConnectorResourceError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `AssociateConnectorResourceError::ThrottlingError`.
    pub fn is_throttling_error(&self) -> bool {
        matches!(self, Self::ThrottlingError(_))
    }
}
impl ::std::error::Error for AssociateConnectorResourceError {
...
impl ::std::fmt::Display for AssociateConnectorResourceError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for AssociateConnectorResourceError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for AssociateConnectorResourceError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AssociateConnectorResourceError {
...
impl ::aws_types::request_id::RequestId
    for crate::operation::associate_connector_resource::AssociateConnectorResourceError
{
...
pub use crate::operation::associate_connector_resource::_associate_connector_resource_input::AssociateConnectorResourceInput;
pub use crate::operation::associate_connector_resource::_associate_connector_resource_output::AssociateConnectorResourceOutput;

mod _associate_connector_resource_input;

mod _associate_connector_resource_output;
