...
/// Orchestration and serialization glue logic for `CreateAssignment`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateAssignment;
impl CreateAssignment {
    /// Creates a new `CreateAssignment`
    pub fn new() -> Self {
        Self
    }
    ...
    pub(crate) async fn orchestrate(
        ...
        input: crate::operation::create_assignment::CreateAssignmentInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_assignment::CreateAssignmentError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_assignment::CreateAssignmentOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateAssignment {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateAssignment");
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                CreateAssignmentResponseDeserializer,
            ),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(CreateAssignmentEndpointParamsInterceptor)
...
#[derive(Debug)]
struct CreateAssignmentResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateAssignmentResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_assignment::de_create_assignment_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_create_assignment::de_create_assignment_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct CreateAssignmentRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateAssignmentRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::create_assignment::CreateAssignmentInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::create_assignment::CreateAssignmentInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_assignment::ser_create_assignment_input(&input)?,
        );
...
#[derive(Debug)]
struct CreateAssignmentEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateAssignmentEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "CreateAssignmentEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<CreateAssignmentInput>()
            .ok_or("failed to downcast to CreateAssignmentInput")?;
...
/// Error type for the `CreateAssignmentError` operation.
#[non_exhaustive]
...
pub enum CreateAssignmentError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateAssignmentError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl CreateAssignmentError {
    /// Creates the `CreateAssignmentError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `CreateAssignmentError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `CreateAssignmentError::ResourceNotFoundError`.
    pub fn is_resource_not_found_error(&self) -> bool {
        matches!(self, Self::ResourceNotFoundError(_))
    }

    /// Returns `true` if the error kind is `CreateAssignmentError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is `CreateAssignmentError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `CreateAssignmentError::ConflictError`.
    pub fn is_conflict_error(&self) -> bool {
        matches!(self, Self::ConflictError(_))
    }

    /// Returns `true` if the error kind is `CreateAssignmentError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `CreateAssignmentError::ThrottlingError`.
    pub fn is_throttling_error(&self) -> bool {
        matches!(self, Self::ThrottlingError(_))
    }
}
impl ::std::error::Error for CreateAssignmentError {
...
impl ::std::fmt::Display for CreateAssignmentError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for CreateAssignmentError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateAssignmentError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateAssignmentError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_assignment::CreateAssignmentError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use crate::operation::create_assignment::_create_assignment_input::CreateAssignmentInput;
pub use crate::operation::create_assignment::_create_assignment_output::CreateAssignmentOutput;

mod _create_assignment_input;

mod _create_assignment_output;
