...
/// Orchestration and serialization glue logic for `CreatePlugin`.
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_plugin::CreatePluginError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_plugin::CreatePluginOutput>()
        ...
        runtime_plugins = runtime_plugins
            .with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
                |token_provider, input| {
                    let input: &mut crate::operation::create_plugin::CreatePluginInput =
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreatePlugin {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreatePlugin");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreatePluginRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreatePluginResponseDeserializer),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(CreatePluginEndpointParamsInterceptor)
...
#[derive(Debug)]
struct CreatePluginResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreatePluginResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_plugin::de_create_plugin_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_create_plugin::de_create_plugin_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct CreatePluginRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreatePluginRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::create_plugin::CreatePluginInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::create_plugin::CreatePluginInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonQDeveloperService.CreatePlugin",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_plugin::ser_create_plugin_input(&input)?,
        );
...
#[derive(Debug)]
struct CreatePluginEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreatePluginEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "CreatePluginEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<CreatePluginInput>()
            .ok_or("failed to downcast to CreatePluginInput")?;
...
/// Error type for the `CreatePluginError` operation.
#[non_exhaustive]
...
pub enum CreatePluginError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreatePluginError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl CreatePluginError {
    /// Creates the `CreatePluginError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `CreatePluginError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `CreatePluginError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is `CreatePluginError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `CreatePluginError::ConflictError`.
    pub fn is_conflict_error(&self) -> bool {
        matches!(self, Self::ConflictError(_))
    }

    /// Returns `true` if the error kind is `CreatePluginError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `CreatePluginError::ThrottlingError`.
    pub fn is_throttling_error(&self) -> bool {
        matches!(self, Self::ThrottlingError(_))
    }
}
impl ::std::error::Error for CreatePluginError {
...
impl ::std::fmt::Display for CreatePluginError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for CreatePluginError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreatePluginError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreatePluginError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_plugin::CreatePluginError {
