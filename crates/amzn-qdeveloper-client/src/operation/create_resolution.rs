...
/// Orchestration and serialization glue logic for `CreateResolution`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateResolution;
impl CreateResolution {
    /// Creates a new `CreateResolution`
    pub fn new() -> Self {
        Self
    }
    ...
    pub(crate) async fn orchestrate(
        ...
        input: crate::operation::create_resolution::CreateResolutionInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_resolution::CreateResolutionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_resolution::CreateResolutionOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateResolution {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateResolution");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateResolutionRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                CreateResolutionResponseDeserializer,
            ),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(CreateResolutionEndpointParamsInterceptor)
...
#[derive(Debug)]
struct CreateResolutionResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateResolutionResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_resolution::de_create_resolution_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_create_resolution::de_create_resolution_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct CreateResolutionRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateResolutionRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::create_resolution::CreateResolutionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::create_resolution::CreateResolutionInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonQDeveloperService.CreateResolution",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_resolution::ser_create_resolution_input(&input)?,
        );
...
#[derive(Debug)]
struct CreateResolutionEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateResolutionEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "CreateResolutionEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<CreateResolutionInput>()
            .ok_or("failed to downcast to CreateResolutionInput")?;
...
/// Error type for the `CreateResolutionError` operation.
#[non_exhaustive]
...
pub enum CreateResolutionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateResolutionError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl CreateResolutionError {
    /// Creates the `CreateResolutionError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `CreateResolutionError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `CreateResolutionError::ResourceNotFoundError`.
    pub fn is_resource_not_found_error(&self) -> bool {
        matches!(self, Self::ResourceNotFoundError(_))
    }

    /// Returns `true` if the error kind is `CreateResolutionError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is `CreateResolutionError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `CreateResolutionError::ConflictError`.
    pub fn is_conflict_error(&self) -> bool {
        matches!(self, Self::ConflictError(_))
    }

    /// Returns `true` if the error kind is `CreateResolutionError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `CreateResolutionError::ServiceQuotaExceededError`.
    pub fn is_service_quota_exceeded_error(&self) -> bool {
        matches!(self, Self::ServiceQuotaExceededError(_))
    }

    /// Returns `true` if the error kind is `CreateResolutionError::ThrottlingError`.
    pub fn is_throttling_error(&self) -> bool {
        matches!(self, Self::ThrottlingError(_))
    }
}
impl ::std::error::Error for CreateResolutionError {
...
impl ::std::fmt::Display for CreateResolutionError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for CreateResolutionError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateResolutionError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateResolutionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_resolution::CreateResolutionError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use crate::operation::create_resolution::_create_resolution_input::CreateResolutionInput;
pub use crate::operation::create_resolution::_create_resolution_output::CreateResolutionOutput;

mod _create_resolution_input;

mod _create_resolution_output;
