    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::delete_extension::DeleteExtensionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::delete_extension::DeleteExtensionOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteExtension {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteExtension");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DeleteExtensionRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                DeleteExtensionResponseDeserializer,
            ),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(DeleteExtensionEndpointParamsInterceptor)
...
#[derive(Debug)]
struct DeleteExtensionResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteExtensionResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_delete_extension::de_delete_extension_http_error(status, headers, body)
        } else {
...
#[derive(Debug)]
struct DeleteExtensionRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteExtensionRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::delete_extension::DeleteExtensionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::delete_extension::DeleteExtensionInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonQDeveloperService.DeleteExtension",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_delete_extension::ser_delete_extension_input(&input)?,
        );
...
#[derive(Debug)]
struct DeleteExtensionEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteExtensionEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "DeleteExtensionEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<DeleteExtensionInput>()
            .ok_or("failed to downcast to DeleteExtensionInput")?;
...
pub enum DeleteExtensionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteExtensionError) for what information is available for the error."
    )]
...
impl DeleteExtensionError {
    ...
    /// Creates the `DeleteExtensionError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `DeleteExtensionError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is `DeleteExtensionError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `DeleteExtensionError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `DeleteExtensionError::ThrottlingError`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteExtensionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_extension::DeleteExtensionError {
