...
/// Orchestration and serialization glue logic for `GetConversation`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetConversation;
impl GetConversation {
    /// Creates a new `GetConversation`
    pub fn new() -> Self {
        Self
    }
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_conversation::GetConversationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_conversation::GetConversationOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetConversation {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetConversation");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetConversationRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                GetConversationResponseDeserializer,
            ),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(GetConversationEndpointParamsInterceptor)
...
#[derive(Debug)]
struct GetConversationResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetConversationResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_conversation::de_get_conversation_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_get_conversation::de_get_conversation_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct GetConversationRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetConversationRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::get_conversation::GetConversationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::get_conversation::GetConversationInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonQDeveloperService.GetConversation",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_conversation::ser_get_conversation_input(&input)?,
        );
...
#[derive(Debug)]
struct GetConversationEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetConversationEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "GetConversationEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<GetConversationInput>()
            .ok_or("failed to downcast to GetConversationInput")?;
...
/// Error type for the `GetConversationError` operation.
#[non_exhaustive]
...
pub enum GetConversationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetConversationError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl GetConversationError {
    /// Creates the `GetConversationError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `GetConversationError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `GetConversationError::ResourceNotFoundError`.
    pub fn is_resource_not_found_error(&self) -> bool {
        matches!(self, Self::ResourceNotFoundError(_))
    }

    /// Returns `true` if the error kind is `GetConversationError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is `GetConversationError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `GetConversationError::ConflictError`.
    pub fn is_conflict_error(&self) -> bool {
        matches!(self, Self::ConflictError(_))
    }

    /// Returns `true` if the error kind is `GetConversationError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `GetConversationError::ServiceQuotaExceededError`.
    pub fn is_service_quota_exceeded_error(&self) -> bool {
        matches!(self, Self::ServiceQuotaExceededError(_))
    }

    /// Returns `true` if the error kind is `GetConversationError::ThrottlingError`.
...
impl ::aws_smithy_types::retry::ProvideErrorKind for GetConversationError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetConversationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetConversationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_conversation::GetConversationError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use crate::operation::get_conversation::_get_conversation_input::GetConversationInput;
pub use crate::operation::get_conversation::_get_conversation_output::GetConversationOutput;

mod _get_conversation_input;

mod _get_conversation_output;
