...
/// Orchestration and serialization glue logic for `GetExtension`.
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_extension::GetExtensionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_extension::GetExtensionOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetExtension {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetExtension");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetExtensionRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetExtensionResponseDeserializer),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(GetExtensionEndpointParamsInterceptor)
...
#[derive(Debug)]
struct GetExtensionResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetExtensionResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_extension::de_get_extension_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_get_extension::de_get_extension_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct GetExtensionRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetExtensionRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::get_extension::GetExtensionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::get_extension::GetExtensionInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonQDeveloperService.GetExtension",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_extension::ser_get_extension_input(&input)?,
        );
...
#[derive(Debug)]
struct GetExtensionEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetExtensionEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "GetExtensionEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<GetExtensionInput>()
            .ok_or("failed to downcast to GetExtensionInput")?;
...
pub enum GetExtensionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetExtensionError) for what information is available for the error."
    )]
...
impl GetExtensionError {
    ...
    /// Creates the `GetExtensionError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `GetExtensionError::ResourceNotFoundError`.
    pub fn is_resource_not_found_error(&self) -> bool {
        matches!(self, Self::ResourceNotFoundError(_))
    }

    /// Returns `true` if the error kind is `GetExtensionError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is `GetExtensionError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `GetExtensionError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `GetExtensionError::ThrottlingError`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetExtensionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_extension::GetExtensionError {
