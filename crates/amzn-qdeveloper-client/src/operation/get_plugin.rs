...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetPlugin {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetPluginResponseDeserializer),
        );
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetPluginRequestSerializer {
    ...
    > {
        let input = input
            .downcast::<crate::operation::get_plugin::GetPluginInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonQDeveloperService.GetPlugin",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_plugin::ser_get_plugin_input(&input)?,
        );
...
impl GetPluginError {
    ...
    /// Creates the `GetPluginError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `GetPluginError::ResourceNotFoundError`.
    pub fn is_resource_not_found_error(&self) -> bool {
        matches!(self, Self::ResourceNotFoundError(_))
    }

    /// Returns `true` if the error kind is `GetPluginError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is `GetPluginError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `GetPluginError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `GetPluginError::ThrottlingError`.
