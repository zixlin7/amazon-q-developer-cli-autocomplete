...
/// Orchestration and serialization glue logic for `GetTroubleshootingResults`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetTroubleshootingResults;
impl GetTroubleshootingResults {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: crate::operation::get_troubleshooting_results::GetTroubleshootingResultsInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_troubleshooting_results::GetTroubleshootingResultsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_troubleshooting_results::GetTroubleshootingResultsOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetTroubleshootingResults {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetTroubleshootingResults");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetTroubleshootingResultsRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                GetTroubleshootingResultsResponseDeserializer,
            ),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(GetTroubleshootingResultsEndpointParamsInterceptor)
...
#[derive(Debug)]
struct GetTroubleshootingResultsResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetTroubleshootingResultsResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_troubleshooting_results::de_get_troubleshooting_results_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_troubleshooting_results::de_get_troubleshooting_results_http_response(
                status, headers, body,
            )
        };
...
#[derive(Debug)]
struct GetTroubleshootingResultsRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetTroubleshootingResultsRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::get_troubleshooting_results::GetTroubleshootingResultsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::get_troubleshooting_results::GetTroubleshootingResultsInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonQDeveloperService.GetTroubleshootingResults",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_troubleshooting_results::ser_get_troubleshooting_results_input(&input)?,
        );
...
#[derive(Debug)]
struct GetTroubleshootingResultsEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetTroubleshootingResultsEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "GetTroubleshootingResultsEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<GetTroubleshootingResultsInput>()
            .ok_or("failed to downcast to GetTroubleshootingResultsInput")?;
...
/// Error type for the `GetTroubleshootingResultsError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum GetTroubleshootingResultsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetTroubleshootingResultsError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl GetTroubleshootingResultsError {
    /// Creates the `GetTroubleshootingResultsError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `GetTroubleshootingResultsError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `GetTroubleshootingResultsError::ResourceNotFoundError`.
    pub fn is_resource_not_found_error(&self) -> bool {
        matches!(self, Self::ResourceNotFoundError(_))
    }

    /// Returns `true` if the error kind is `GetTroubleshootingResultsError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is `GetTroubleshootingResultsError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `GetTroubleshootingResultsError::ConflictError`.
    pub fn is_conflict_error(&self) -> bool {
        matches!(self, Self::ConflictError(_))
    }

    /// Returns `true` if the error kind is `GetTroubleshootingResultsError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is
    /// `GetTroubleshootingResultsError::ServiceQuotaExceededError`.
    pub fn is_service_quota_exceeded_error(&self) -> bool {
        matches!(self, Self::ServiceQuotaExceededError(_))
    }

    /// Returns `true` if the error kind is `GetTroubleshootingResultsError::ThrottlingError`.
    pub fn is_throttling_error(&self) -> bool {
        matches!(self, Self::ThrottlingError(_))
    }
}
impl ::std::error::Error for GetTroubleshootingResultsError {
...
impl ::std::fmt::Display for GetTroubleshootingResultsError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for GetTroubleshootingResultsError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetTroubleshootingResultsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetTroubleshootingResultsError {
...
impl ::aws_types::request_id::RequestId
    for crate::operation::get_troubleshooting_results::GetTroubleshootingResultsError
{
...
pub use crate::operation::get_troubleshooting_results::_get_troubleshooting_results_input::GetTroubleshootingResultsInput;
pub use crate::operation::get_troubleshooting_results::_get_troubleshooting_results_output::GetTroubleshootingResultsOutput;

mod _get_troubleshooting_results_input;

mod _get_troubleshooting_results_output;
