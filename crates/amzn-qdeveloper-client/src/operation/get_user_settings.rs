    ...
    > {
        ...
        let mut request_builder = {
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonQDeveloperService.GetUserSettings",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_user_settings::ser_get_user_settings_input(&input)?,
        );
...
impl GetUserSettingsError {
    ...
    /// Creates the `GetUserSettingsError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `GetUserSettingsError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is `GetUserSettingsError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `GetUserSettingsError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `GetUserSettingsError::ThrottlingError`.
