...
/// Orchestration and serialization glue logic for `InvokeTask`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct InvokeTask;
impl InvokeTask {
    /// Creates a new `InvokeTask`
    pub fn new() -> Self {
        Self
    }
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::invoke_task::InvokeTaskError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::invoke_task::InvokeTaskOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for InvokeTask {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("InvokeTask");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            InvokeTaskRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(InvokeTaskResponseDeserializer),
        );
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("InvokeTask")
            .with_interceptor(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            )
            .with_interceptor(InvokeTaskEndpointParamsInterceptor)
...
#[derive(Debug)]
struct InvokeTaskResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for InvokeTaskResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_invoke_task::de_invoke_task_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_invoke_task::de_invoke_task_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct InvokeTaskRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for InvokeTaskRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::invoke_task::InvokeTaskInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::invoke_task::InvokeTaskInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonQDeveloperService.InvokeTask",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_invoke_task::ser_invoke_task_input(&input)?,
        );
...
#[derive(Debug)]
struct InvokeTaskEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for InvokeTaskEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "InvokeTaskEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<InvokeTaskInput>()
            .ok_or("failed to downcast to InvokeTaskInput")?;
...
/// Error type for the `InvokeTaskError` operation.
#[non_exhaustive]
...
pub enum InvokeTaskError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-InvokeTaskError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl InvokeTaskError {
    /// Creates the `InvokeTaskError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `InvokeTaskError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `InvokeTaskError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `InvokeTaskError::ConflictError`.
    pub fn is_conflict_error(&self) -> bool {
        matches!(self, Self::ConflictError(_))
    }

    /// Returns `true` if the error kind is `InvokeTaskError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `InvokeTaskError::ThrottlingError`.
...
impl ::aws_smithy_types::retry::ProvideErrorKind for InvokeTaskError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for InvokeTaskError {
...
impl ::aws_types::request_id::RequestId for crate::operation::invoke_task::InvokeTaskError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use crate::operation::invoke_task::_invoke_task_input::InvokeTaskInput;
pub use crate::operation::invoke_task::_invoke_task_output::InvokeTaskOutput;

mod _invoke_task_input;

mod _invoke_task_output;
