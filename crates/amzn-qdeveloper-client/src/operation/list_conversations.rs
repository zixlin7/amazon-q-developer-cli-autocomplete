    ...
    > {
        ...
        let mut request_builder = {
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonQDeveloperService.ListConversations",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_list_conversations::ser_list_conversations_input(&input)?,
        );
...
impl ListConversationsError {
    ...
    /// Creates the `ListConversationsError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `ListConversationsError::ServiceQuotaExceededError`.
    pub fn is_service_quota_exceeded_error(&self) -> bool {
        matches!(self, Self::ServiceQuotaExceededError(_))
    }

    /// Returns `true` if the error kind is `ListConversationsError::ThrottlingError`.
