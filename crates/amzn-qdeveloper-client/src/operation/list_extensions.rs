...
/// Orchestration and serialization glue logic for `ListExtensions`.
...
impl ListExtensions {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: crate::operation::list_extensions::ListExtensionsInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_extensions::ListExtensionsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_extensions::ListExtensionsOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListExtensions {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListExtensions");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListExtensionsRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                ListExtensionsResponseDeserializer,
            ),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(ListExtensionsEndpointParamsInterceptor)
...
#[derive(Debug)]
struct ListExtensionsResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListExtensionsResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_extensions::de_list_extensions_http_error(status, headers, body)
        } else {
...
#[derive(Debug)]
struct ListExtensionsRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListExtensionsRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::list_extensions::ListExtensionsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::list_extensions::ListExtensionsInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonQDeveloperService.ListExtensions",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_list_extensions::ser_list_extensions_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListExtensionsEndpointParamsInterceptor {
    ...
    fn read_before_execution(
        ...
        let _input = context
            ...
            .ok_or("failed to downcast to ListExtensionsInput")?;
...
pub enum ListExtensionsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListExtensionsError) for what information is available for the error."
    )]
...
impl ListExtensionsError {
    ...
    /// Creates the `ListExtensionsError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `ListExtensionsError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is `ListExtensionsError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `ListExtensionsError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `ListExtensionsError::ThrottlingError`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListExtensionsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_extensions::ListExtensionsError {
