...
impl ListExtensionsPaginator {
    ...
    ///
    /// This paginator automatically flattens results using `extensions`. Queries to the underlying
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(
            ::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_extensions::ListExtensions::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_extensions_output_output_next_token(resp);
...
impl ListExtensionsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_extensions_output_output_extensions(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
