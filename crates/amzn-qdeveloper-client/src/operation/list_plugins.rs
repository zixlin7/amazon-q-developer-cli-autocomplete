...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListPlugins {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListPluginsResponseDeserializer),
        );
    ...
    > {
        ...
        let mut request_builder = {
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonQDeveloperService.ListPlugins",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_list_plugins::ser_list_plugins_input(&input)?,
        );
...
impl ListPluginsError {
    ...
    /// Creates the `ListPluginsError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `ListPluginsError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is `ListPluginsError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `ListPluginsError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `ListPluginsError::ThrottlingError`.
