...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListTasks {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListTasksResponseDeserializer),
        );
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListTasksRequestSerializer {
    ...
    > {
        let input = input
            .downcast::<crate::operation::list_tasks::ListTasksInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonQDeveloperService.ListTasks",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_list_tasks::ser_list_tasks_input(&input)?,
        );
...
impl ListTasksError {
    ...
    /// Creates the `ListTasksError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `ListTasksError::ResourceNotFoundError`.
    pub fn is_resource_not_found_error(&self) -> bool {
        matches!(self, Self::ResourceNotFoundError(_))
    }

    /// Returns `true` if the error kind is `ListTasksError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is `ListTasksError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `ListTasksError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `ListTasksError::ThrottlingError`.
