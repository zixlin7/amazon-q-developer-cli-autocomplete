...
///
/// API to get list of N recent tasks
...
impl ListTasksFluentBuilder {
    ...
    /// [`send().await`](crate::operation::list_tasks::paginator::ListTasksPaginator::send) which
