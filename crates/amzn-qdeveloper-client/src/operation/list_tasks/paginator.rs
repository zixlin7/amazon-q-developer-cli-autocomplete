...
impl ListTasksPaginator {
    ...
    ///
    /// This paginator automatically flattens results using `tasks`. Queries to the underlying
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(
            ::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            crate::operation::list_tasks::ListTasks::orchestrate(&runtime_plugins, input.clone()).await;
...
impl ListTasksPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_tasks_output_output_tasks(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
