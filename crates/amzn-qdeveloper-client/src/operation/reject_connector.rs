...
/// Orchestration and serialization glue logic for `RejectConnector`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct RejectConnector;
impl RejectConnector {
    /// Creates a new `RejectConnector`
    pub fn new() -> Self {
        Self
    }
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::reject_connector::RejectConnectorError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::reject_connector::RejectConnectorOutput>()
        ...
        runtime_plugins = runtime_plugins
            .with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
                |token_provider, input| {
                    let input: &mut crate::operation::reject_connector::RejectConnectorInput =
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RejectConnector {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RejectConnector");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            RejectConnectorRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                RejectConnectorResponseDeserializer,
            ),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(RejectConnectorEndpointParamsInterceptor)
...
#[derive(Debug)]
struct RejectConnectorResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RejectConnectorResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_reject_connector::de_reject_connector_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_reject_connector::de_reject_connector_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct RejectConnectorRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RejectConnectorRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::reject_connector::RejectConnectorInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::reject_connector::RejectConnectorInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonQDeveloperService.RejectConnector",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_reject_connector::ser_reject_connector_input(&input)?,
        );
...
#[derive(Debug)]
struct RejectConnectorEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RejectConnectorEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "RejectConnectorEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<RejectConnectorInput>()
            .ok_or("failed to downcast to RejectConnectorInput")?;
...
/// Error type for the `RejectConnectorError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum RejectConnectorError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RejectConnectorError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl RejectConnectorError {
    /// Creates the `RejectConnectorError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `RejectConnectorError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `RejectConnectorError::ResourceNotFoundError`.
    pub fn is_resource_not_found_error(&self) -> bool {
        matches!(self, Self::ResourceNotFoundError(_))
    }

    /// Returns `true` if the error kind is `RejectConnectorError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is `RejectConnectorError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `RejectConnectorError::ConflictError`.
    pub fn is_conflict_error(&self) -> bool {
        matches!(self, Self::ConflictError(_))
    }

    /// Returns `true` if the error kind is `RejectConnectorError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `RejectConnectorError::ThrottlingError`.
    pub fn is_throttling_error(&self) -> bool {
        matches!(self, Self::ThrottlingError(_))
    }
}
impl ::std::error::Error for RejectConnectorError {
...
impl ::std::fmt::Display for RejectConnectorError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for RejectConnectorError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for RejectConnectorError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RejectConnectorError {
...
impl ::aws_types::request_id::RequestId for crate::operation::reject_connector::RejectConnectorError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use crate::operation::reject_connector::_reject_connector_input::RejectConnectorInput;
pub use crate::operation::reject_connector::_reject_connector_output::RejectConnectorOutput;

mod _reject_connector_input;

mod _reject_connector_output;
