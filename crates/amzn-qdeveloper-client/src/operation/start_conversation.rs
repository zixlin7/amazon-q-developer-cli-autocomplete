...
/// Orchestration and serialization glue logic for `StartConversation`.
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::start_conversation::StartConversationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::start_conversation::StartConversationOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartConversation {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartConversation");
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                StartConversationResponseDeserializer,
            ),
        );
...
#[derive(Debug)]
struct StartConversationResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartConversationResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_start_conversation::de_start_conversation_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_start_conversation::de_start_conversation_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct StartConversationRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartConversationRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::start_conversation::StartConversationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::start_conversation::StartConversationInput,
            ...
            ) -> ::std::result::Result<::http::request::Builder, ::aws_smithy_types::error::operation::BuildError>
            {
                ...
                let builder =
                    crate::protocol_serde::shape_start_conversation::ser_start_conversation_headers(input, builder)?;
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonQDeveloperService.StartConversation",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_start_conversation::ser_start_conversation_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartConversationEndpointParamsInterceptor {
    ...
    fn read_before_execution(
        ...
        let _input = context
            ...
            .ok_or("failed to downcast to StartConversationInput")?;
...
/// Error type for the `StartConversationError` operation.
#[non_exhaustive]
...
pub enum StartConversationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartConversationError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl StartConversationError {
    /// Creates the `StartConversationError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `StartConversationError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `StartConversationError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `StartConversationError::ConflictError`.
    pub fn is_conflict_error(&self) -> bool {
        matches!(self, Self::ConflictError(_))
    }

    /// Returns `true` if the error kind is `StartConversationError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `StartConversationError::ServiceQuotaExceededError`.
    pub fn is_service_quota_exceeded_error(&self) -> bool {
        matches!(self, Self::ServiceQuotaExceededError(_))
    }

    /// Returns `true` if the error kind is `StartConversationError::ThrottlingError`.
    pub fn is_throttling_error(&self) -> bool {
        matches!(self, Self::ThrottlingError(_))
    }

    /// Returns `true` if the error kind is `StartConversationError::DryRunOperationError`.
...
impl ::aws_smithy_types::retry::ProvideErrorKind for StartConversationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartConversationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_conversation::StartConversationError {
...
mod _start_conversation_output;
