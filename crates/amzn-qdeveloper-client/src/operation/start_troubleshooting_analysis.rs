...
/// Orchestration and serialization glue logic for `StartTroubleshootingAnalysis`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct StartTroubleshootingAnalysis;
impl StartTroubleshootingAnalysis {
    /// Creates a new `StartTroubleshootingAnalysis`
    pub fn new() -> Self {
        Self
    }
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::start_troubleshooting_analysis::StartTroubleshootingAnalysisError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::start_troubleshooting_analysis::StartTroubleshootingAnalysisOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartTroubleshootingAnalysis {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartTroubleshootingAnalysis");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            StartTroubleshootingAnalysisRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                StartTroubleshootingAnalysisResponseDeserializer,
            ),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(StartTroubleshootingAnalysisEndpointParamsInterceptor)
...
#[derive(Debug)]
struct StartTroubleshootingAnalysisResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for StartTroubleshootingAnalysisResponseDeserializer
{
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_start_troubleshooting_analysis::de_start_troubleshooting_analysis_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_start_troubleshooting_analysis::de_start_troubleshooting_analysis_http_response(
                status, headers, body,
            )
        };
...
#[derive(Debug)]
struct StartTroubleshootingAnalysisRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartTroubleshootingAnalysisRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::start_troubleshooting_analysis::StartTroubleshootingAnalysisInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::start_troubleshooting_analysis::StartTroubleshootingAnalysisInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonQDeveloperService.StartTroubleshootingAnalysis",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_start_troubleshooting_analysis::ser_start_troubleshooting_analysis_input(
                &input,
            )?,
        );
...
#[derive(Debug)]
struct StartTroubleshootingAnalysisEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for StartTroubleshootingAnalysisEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "StartTroubleshootingAnalysisEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<StartTroubleshootingAnalysisInput>()
            .ok_or("failed to downcast to StartTroubleshootingAnalysisInput")?;
...
/// Error type for the `StartTroubleshootingAnalysisError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum StartTroubleshootingAnalysisError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartTroubleshootingAnalysisError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl StartTroubleshootingAnalysisError {
    /// Creates the `StartTroubleshootingAnalysisError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `StartTroubleshootingAnalysisError::Unhandled` variant from an
    ...
    /// `StartTroubleshootingAnalysisError::InternalServerError`.
    ...
    /// Returns `true` if the error kind is
    /// `StartTroubleshootingAnalysisError::ServiceQuotaExceededError`.
    pub fn is_service_quota_exceeded_error(&self) -> bool {
        matches!(self, Self::ServiceQuotaExceededError(_))
    }

    /// Returns `true` if the error kind is `StartTroubleshootingAnalysisError::ThrottlingError`.
    pub fn is_throttling_error(&self) -> bool {
        matches!(self, Self::ThrottlingError(_))
    }
}
impl ::std::error::Error for StartTroubleshootingAnalysisError {
...
impl ::std::fmt::Display for StartTroubleshootingAnalysisError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for StartTroubleshootingAnalysisError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for StartTroubleshootingAnalysisError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartTroubleshootingAnalysisError {
...
impl ::aws_types::request_id::RequestId
    for crate::operation::start_troubleshooting_analysis::StartTroubleshootingAnalysisError
{
...
pub use crate::operation::start_troubleshooting_analysis::_start_troubleshooting_analysis_input::StartTroubleshootingAnalysisInput;
pub use crate::operation::start_troubleshooting_analysis::_start_troubleshooting_analysis_output::StartTroubleshootingAnalysisOutput;

mod _start_troubleshooting_analysis_input;
