...
/// Orchestration and serialization glue logic for `UpdateTroubleshootingCommandResult`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateTroubleshootingCommandResult;
impl UpdateTroubleshootingCommandResult {
    /// Creates a new `UpdateTroubleshootingCommandResult`
    pub fn new() -> Self {
        Self
    }
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::update_troubleshooting_command_result::UpdateTroubleshootingCommandResultError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::update_troubleshooting_command_result::UpdateTroubleshootingCommandResultOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateTroubleshootingCommandResult {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateTroubleshootingCommandResult");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UpdateTroubleshootingCommandResultRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                UpdateTroubleshootingCommandResultResponseDeserializer,
            ),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(UpdateTroubleshootingCommandResultEndpointParamsInterceptor)
...
#[derive(Debug)]
struct UpdateTroubleshootingCommandResultResponseDeserializer;
    ...
    for UpdateTroubleshootingCommandResultResponseDeserializer
{
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_update_troubleshooting_command_result::de_update_troubleshooting_command_result_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_troubleshooting_command_result::de_update_troubleshooting_command_result_http_response(
                status, headers, body,
            )
        };
...
#[derive(Debug)]
struct UpdateTroubleshootingCommandResultRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for UpdateTroubleshootingCommandResultRequestSerializer
{
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::update_troubleshooting_command_result::UpdateTroubleshootingCommandResultInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::update_troubleshooting_command_result::UpdateTroubleshootingCommandResultInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonQDeveloperService.UpdateTroubleshootingCommandResult",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_update_troubleshooting_command_result::ser_update_troubleshooting_command_result_input(&input)?,
        );
...
#[derive(Debug)]
struct UpdateTroubleshootingCommandResultEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for UpdateTroubleshootingCommandResultEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "UpdateTroubleshootingCommandResultEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<UpdateTroubleshootingCommandResultInput>()
            .ok_or("failed to downcast to UpdateTroubleshootingCommandResultInput")?;
...
/// Error type for the `UpdateTroubleshootingCommandResultError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum UpdateTroubleshootingCommandResultError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateTroubleshootingCommandResultError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl UpdateTroubleshootingCommandResultError {
    /// Creates the `UpdateTroubleshootingCommandResultError::Unhandled` variant from any error
    /// type.
    pub fn unhandled(
    ...
    /// Creates the `UpdateTroubleshootingCommandResultError::Unhandled` variant from an
    ...
    /// `UpdateTroubleshootingCommandResultError::ResourceNotFoundError`.
    pub fn is_resource_not_found_error(&self) -> bool {
        matches!(self, Self::ResourceNotFoundError(_))
    }

    /// Returns `true` if the error kind is
    /// `UpdateTroubleshootingCommandResultError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is
    /// `UpdateTroubleshootingCommandResultError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is
    /// `UpdateTroubleshootingCommandResultError::ConflictError`.
    pub fn is_conflict_error(&self) -> bool {
        matches!(self, Self::ConflictError(_))
    }

    /// Returns `true` if the error kind is
    /// `UpdateTroubleshootingCommandResultError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is
    /// `UpdateTroubleshootingCommandResultError::ServiceQuotaExceededError`.
    pub fn is_service_quota_exceeded_error(&self) -> bool {
        matches!(self, Self::ServiceQuotaExceededError(_))
    }

    /// Returns `true` if the error kind is
    /// `UpdateTroubleshootingCommandResultError::ThrottlingError`.
    pub fn is_throttling_error(&self) -> bool {
        matches!(self, Self::ThrottlingError(_))
    }
}
impl ::std::error::Error for UpdateTroubleshootingCommandResultError {
...
impl ::std::fmt::Display for UpdateTroubleshootingCommandResultError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for UpdateTroubleshootingCommandResultError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateTroubleshootingCommandResultError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateTroubleshootingCommandResultError {
...
impl ::aws_types::request_id::RequestId
    for crate::operation::update_troubleshooting_command_result::UpdateTroubleshootingCommandResultError
{
...
pub use crate::operation::update_troubleshooting_command_result::_update_troubleshooting_command_result_input::UpdateTroubleshootingCommandResultInput;
pub use crate::operation::update_troubleshooting_command_result::_update_troubleshooting_command_result_output::UpdateTroubleshootingCommandResultOutput;

mod _update_troubleshooting_command_result_input;

mod _update_troubleshooting_command_result_output;
