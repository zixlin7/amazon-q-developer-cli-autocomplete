...
/// Orchestration and serialization glue logic for `UpdateUserSettings`.
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::update_user_settings::UpdateUserSettingsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::update_user_settings::UpdateUserSettingsOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateUserSettings {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateUserSettings");
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                UpdateUserSettingsResponseDeserializer,
            ),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(UpdateUserSettingsEndpointParamsInterceptor)
...
#[derive(Debug)]
struct UpdateUserSettingsResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateUserSettingsResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_update_user_settings::de_update_user_settings_http_error(status, headers, body)
        } else {
...
#[derive(Debug)]
struct UpdateUserSettingsRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateUserSettingsRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::update_user_settings::UpdateUserSettingsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::update_user_settings::UpdateUserSettingsInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonQDeveloperService.UpdateUserSettings",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_update_user_settings::ser_update_user_settings_input(&input)?,
        );
...
#[derive(Debug)]
struct UpdateUserSettingsEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateUserSettingsEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "UpdateUserSettingsEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<UpdateUserSettingsInput>()
            .ok_or("failed to downcast to UpdateUserSettingsInput")?;
...
pub enum UpdateUserSettingsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateUserSettingsError) for what information is available for the error."
    )]
...
impl UpdateUserSettingsError {
    ...
    /// Creates the `UpdateUserSettingsError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `UpdateUserSettingsError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is `UpdateUserSettingsError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `UpdateUserSettingsError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `UpdateUserSettingsError::ThrottlingError`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateUserSettingsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_user_settings::UpdateUserSettingsError {
...
mod _update_user_settings_output;
