...
///
/// API for the users to update their client/user Settings in Q
...
impl UpdateUserSettingsFluentBuilder {
    /// Creates a new `UpdateUserSettingsFluentBuilder`.
    ...
    pub fn cross_region_calls_consent(mut self, input: crate::types::CrossRegionCallsConsent) -> Self {
        self.inner = self.inner.cross_region_calls_consent(input);
        self
    }
    ...
    pub fn set_cross_region_calls_consent(
        ...
        self.inner = self.inner.set_cross_region_calls_consent(input);
        self
    }

    /// Value for crossRegionCallsConsent setting
    pub fn get_cross_region_calls_consent(&self) -> &::std::option::Option<crate::types::CrossRegionCallsConsent> {
        self.inner.get_cross_region_calls_consent()
    }
}
