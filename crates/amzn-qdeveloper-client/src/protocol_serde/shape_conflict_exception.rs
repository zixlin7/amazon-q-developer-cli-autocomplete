...
) -> Result<crate::types::error::builders::ConflictErrorBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
                ...
                "reason" => {
                    builder = builder.set_reason(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| {
                                s.to_unescaped()
                                    .map(|u| crate::types::ConflictExceptionReason::from(u.as_ref()))
                            })
                            .transpose()?,
                    );
                },
