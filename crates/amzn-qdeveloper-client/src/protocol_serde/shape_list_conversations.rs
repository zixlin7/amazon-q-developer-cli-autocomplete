...
pub fn de_list_conversations_http_error(
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::list_conversations::ListConversationsError::unhandled(
                generic,
            ));
        },
    };
    ...
    Err(match error_code {
        ...
        "AccessDeniedException" => crate::operation::list_conversations::ListConversationsError::AccessDeniedError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ValidationException" => crate::operation::list_conversations::ListConversationsError::ValidationError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceQuotaExceededException" => {
            crate::operation::list_conversations::ListConversationsError::ServiceQuotaExceededError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ThrottlingException" => crate::operation::list_conversations::ListConversationsError::ThrottlingError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => crate::operation::list_conversations::ListConversationsError::generic(generic),
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_list_conversations_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::list_conversations::builders::ListConversationsOutputBuilder::default();
        output = crate::protocol_serde::shape_list_conversations::de_list_conversations(_response_body, output)
            .map_err(crate::operation::list_conversations::ListConversationsError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::list_conversations_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_conversations::ListConversationsError::unhandled)?
    })
}

pub fn ser_list_conversations_input(
    input: &crate::operation::list_conversations::ListConversationsInput,
) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_list_conversations_input::ser_list_conversations_input_input(&mut object, input)?;
    object.finish();
    Ok(::aws_smithy_types::body::SdkBody::from(out))
}

pub(crate) fn de_list_conversations(
    value: &[u8],
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "conversations" => {
                    builder = builder.set_conversations(
                        crate::protocol_serde::shape_conversation_metadata_list::de_conversation_metadata_list(tokens)?,
                    );
                },
                "nextToken" => {
