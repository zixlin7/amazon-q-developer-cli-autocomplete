...
pub fn de_send_event_http_error(
    ...
    Err(match error_code {
        "InternalServerException" => crate::operation::send_event::SendEventError::InternalServerError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "AccessDeniedException" => crate::operation::send_event::SendEventError::AccessDeniedError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ValidationException" => crate::operation::send_event::SendEventError::ValidationError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ThrottlingException" => crate::operation::send_event::SendEventError::ThrottlingError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn ser_send_event_headers(
    ...
    if let ::std::option::Option::Some(inner_3) = &input.provider_id {
        ...
        if !formatted_4.is_empty() {
            ...
            builder = builder.header("X-Provider-Id", header_value);
        }
    }
    if let ::std::option::Option::Some(inner_5) = &input.event_id {
        ...
        if !formatted_6.is_empty() {
            ...
            builder = builder.header("X-Event-Id", header_value);
        }
    }
    if let ::std::option::Option::Some(inner_7) = &input.event_version {
        ...
        if !formatted_8.is_empty() {
            ...
            builder = builder.header("X-Event-Version", header_value);
        }
    }
    Ok(builder)
}
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "providerId" => {
                    builder = builder.set_provider_id(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| {
                                s.to_unescaped()
                                    .map(|u| crate::types::SupportedProviderId::from(u.as_ref()))
                            })
                            .transpose()?,
                    );
                },
