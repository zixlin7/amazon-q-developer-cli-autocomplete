...
pub enum ConnectorResource {
    #[allow(missing_docs)] // documentation missing in model
    RoleArn(::std::string::String),
...
impl ConnectorResource {
    ...
    /// [`RoleArn`](crate::types::ConnectorResource::RoleArn), extracting the inner
    /// [`String`](::std::string::String). Returns `Err(&Self)` if it can't be converted.
    pub fn as_role_arn(&self) -> ::std::result::Result<&::std::string::String, &Self> {
        if let ConnectorResource::RoleArn(val) = &self {
    ...
    /// Returns true if this is a [`RoleArn`](crate::types::ConnectorResource::RoleArn).
    pub fn is_role_arn(&self) -> bool {
        self.as_role_arn().is_ok()
    }
