...
/// Orchestration and serialization glue logic for `GenerateCodeFromCommands`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GenerateCodeFromCommands;
impl GenerateCodeFromCommands {
    /// Creates a new `GenerateCodeFromCommands`
    pub fn new() -> Self {
        Self
    }
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::generate_code_from_commands::GenerateCodeFromCommandsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::generate_code_from_commands::GenerateCodeFromCommandsOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GenerateCodeFromCommands {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GenerateCodeFromCommands");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GenerateCodeFromCommandsRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                GenerateCodeFromCommandsResponseDeserializer,
            ),
        );
...
#[derive(Debug)]
struct GenerateCodeFromCommandsResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GenerateCodeFromCommandsResponseDeserializer {
    fn deserialize_streaming(
        ...
        ::std::option::Option::Some(crate::protocol_serde::type_erase_result(
            crate::protocol_serde::shape_generate_code_from_commands::de_generate_code_from_commands_http_response(
                response,
            ),
        ))
    }
    ...
    fn deserialize_nonstreaming(
        ...
        crate::protocol_serde::type_erase_result(
            crate::protocol_serde::shape_generate_code_from_commands::de_generate_code_from_commands_http_error(
...
#[derive(Debug)]
struct GenerateCodeFromCommandsRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GenerateCodeFromCommandsRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::generate_code_from_commands::GenerateCodeFromCommandsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::generate_code_from_commands::GenerateCodeFromCommandsInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonQDeveloperStreamingService.GenerateCodeFromCommands",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_generate_code_from_commands::ser_generate_code_from_commands_input(&input)?,
        );
...
#[derive(Debug)]
struct GenerateCodeFromCommandsEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GenerateCodeFromCommandsEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "GenerateCodeFromCommandsEndpointParamsInterceptor"
    }
...
/// Error type for the `GenerateCodeFromCommandsError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum GenerateCodeFromCommandsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GenerateCodeFromCommandsError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl GenerateCodeFromCommandsError {
    /// Creates the `GenerateCodeFromCommandsError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `GenerateCodeFromCommandsError::Unhandled` variant from an
    ...
    /// `GenerateCodeFromCommandsError::ServiceQuotaExceededError`.
    pub fn is_service_quota_exceeded_error(&self) -> bool {
        matches!(self, Self::ServiceQuotaExceededError(_))
    }

    /// Returns `true` if the error kind is `GenerateCodeFromCommandsError::ThrottlingError`.
    pub fn is_throttling_error(&self) -> bool {
        matches!(self, Self::ThrottlingError(_))
    }

    /// Returns `true` if the error kind is `GenerateCodeFromCommandsError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `GenerateCodeFromCommandsError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `GenerateCodeFromCommandsError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }
}
impl ::std::error::Error for GenerateCodeFromCommandsError {
...
impl ::std::fmt::Display for GenerateCodeFromCommandsError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for GenerateCodeFromCommandsError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GenerateCodeFromCommandsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GenerateCodeFromCommandsError {
...
impl ::aws_types::request_id::RequestId
    for crate::operation::generate_code_from_commands::GenerateCodeFromCommandsError
{
...
pub use crate::operation::generate_code_from_commands::_generate_code_from_commands_input::GenerateCodeFromCommandsInput;
pub use crate::operation::generate_code_from_commands::_generate_code_from_commands_output::GenerateCodeFromCommandsOutput;

mod _generate_code_from_commands_input;

mod _generate_code_from_commands_output;
