...
/// Orchestration and serialization glue logic for `GetTransformation`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetTransformation;
impl GetTransformation {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_transformation::GetTransformationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_transformation::GetTransformationOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetTransformation {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetTransformation");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetTransformationRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                GetTransformationResponseDeserializer,
            ),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(GetTransformationEndpointParamsInterceptor)
...
#[derive(Debug)]
struct GetTransformationResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetTransformationResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_transformation::de_get_transformation_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_get_transformation::de_get_transformation_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct GetTransformationRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetTransformationRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::get_transformation::GetTransformationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::get_transformation::GetTransformationInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonCodeWhispererService.GetTransformation",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_transformation::ser_get_transformation_input(&input)?,
        );
...
#[derive(Debug)]
struct GetTransformationEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetTransformationEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "GetTransformationEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<GetTransformationInput>()
            .ok_or("failed to downcast to GetTransformationInput")?;
...
/// Error type for the `GetTransformationError` operation.
#[non_exhaustive]
...
pub enum GetTransformationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetTransformationError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl GetTransformationError {
    /// Creates the `GetTransformationError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `GetTransformationError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `GetTransformationError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is `GetTransformationError::ThrottlingError`.
    pub fn is_throttling_error(&self) -> bool {
        matches!(self, Self::ThrottlingError(_))
    }

    /// Returns `true` if the error kind is `GetTransformationError::ValidationError`.
...
impl ::std::error::Error for GetTransformationError {
...
impl ::std::fmt::Display for GetTransformationError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for GetTransformationError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetTransformationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetTransformationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_transformation::GetTransformationError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use crate::operation::get_transformation::_get_transformation_input::GetTransformationInput;
pub use crate::operation::get_transformation::_get_transformation_output::GetTransformationOutput;

mod _get_transformation_input;

mod _get_transformation_output;
