...
pub fn de_start_task_assist_code_generation_http_error(
...
> {
    ...
    Err(match error_code {
        "InternalServerException" => crate::operation::start_task_assist_code_generation::StartTaskAssistCodeGenerationError::InternalServerError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => crate::operation::start_task_assist_code_generation::StartTaskAssistCodeGenerationError::generic(generic),
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_start_task_assist_code_generation_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
