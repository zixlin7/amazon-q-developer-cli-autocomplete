...
impl ::std::convert::From<&str> for ArtifactType {
    fn from(s: &str) -> Self {
        match s {
            "BuiltJars" => ArtifactType::BuiltJars,
            "SourceCode" => ArtifactType::SourceCode,
            other => ArtifactType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(
                other.to_owned(),
            )),
        }
    }
...
impl ArtifactType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ArtifactType::BuiltJars => "BuiltJars",
            ArtifactType::SourceCode => "SourceCode",
