...
pub(crate) fn de_binary_metadata_event_payload(
    input: &[u8],
) -> Result<crate::types::BinaryMetadataEvent, ::aws_smithy_json::deserialize::error::DeserializeError> {
...
) -> Result<Option<crate::types::BinaryMetadataEvent>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<
        Item = Result<
