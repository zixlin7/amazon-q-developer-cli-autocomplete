...
pub struct AssociateCustomizationPermissionOutput {
    _request_id: Option<String>,
}
impl ::aws_types::request_id::RequestId for AssociateCustomizationPermissionOutput {
...
impl AssociateCustomizationPermissionOutputBuilder {
