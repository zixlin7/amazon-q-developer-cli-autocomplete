...
impl ListCustomizations {
    /// Creates a new `ListCustomizations`
    pub fn new() -> Self {
        Self
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListCustomizations {
    ...
    fn runtime_components(
        ...
        .with_interceptor(ListCustomizationsEndpointParamsInterceptor)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListCustomizationsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListCustomizationsRequestSerializer {
    #[allow(
        unused_mut,
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListCustomizationsEndpointParamsInterceptor {
...
pub enum ListCustomizationsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListCustomizationsError) for what information is available for the error."
    )]
...
impl ListCustomizationsError {
    ...
    /// Creates the `ListCustomizationsError::Unhandled` variant from an
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListCustomizationsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_customizations::ListCustomizationsError {
