...
pub fn de_allow_vended_log_delivery_for_resource_http_error(
...
> {
    ...
    Err(match error_code {
        ...
        "ThrottlingException" => crate::operation::allow_vended_log_delivery_for_resource::AllowVendedLogDeliveryForResourceError::ThrottlingError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => crate::operation::allow_vended_log_delivery_for_resource::AllowVendedLogDeliveryForResourceError::generic(generic),
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_allow_vended_log_delivery_for_resource_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_allow_vended_log_delivery_for_resource::de_allow_vended_log_delivery_for_resource(_response_body, output)
                .map_err(crate::operation::allow_vended_log_delivery_for_resource::AllowVendedLogDeliveryForResourceError::unhandled)?;
