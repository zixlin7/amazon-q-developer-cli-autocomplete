...
/// Orchestration and serialization glue logic for `DeleteAssignment`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DeleteAssignment;
impl DeleteAssignment {
    /// Creates a new `DeleteAssignment`
    pub fn new() -> Self {
        Self
    }
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::delete_assignment::DeleteAssignmentError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::delete_assignment::DeleteAssignmentOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteAssignment {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteAssignment");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DeleteAssignmentRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                DeleteAssignmentResponseDeserializer,
            ),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(DeleteAssignmentEndpointParamsInterceptor)
...
#[derive(Debug)]
struct DeleteAssignmentResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteAssignmentResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_delete_assignment::de_delete_assignment_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_delete_assignment::de_delete_assignment_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct DeleteAssignmentRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteAssignmentRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::delete_assignment::DeleteAssignmentInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::delete_assignment::DeleteAssignmentInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_delete_assignment::ser_delete_assignment_input(&input)?,
        );
...
#[derive(Debug)]
struct DeleteAssignmentEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteAssignmentEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "DeleteAssignmentEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<DeleteAssignmentInput>()
            .ok_or("failed to downcast to DeleteAssignmentInput")?;
...
/// Error type for the `DeleteAssignmentError` operation.
#[non_exhaustive]
...
pub enum DeleteAssignmentError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteAssignmentError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl DeleteAssignmentError {
    /// Creates the `DeleteAssignmentError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `DeleteAssignmentError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `DeleteAssignmentError::ResourceNotFoundError`.
    pub fn is_resource_not_found_error(&self) -> bool {
        matches!(self, Self::ResourceNotFoundError(_))
    }

    /// Returns `true` if the error kind is `DeleteAssignmentError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is `DeleteAssignmentError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `DeleteAssignmentError::ConflictError`.
    pub fn is_conflict_error(&self) -> bool {
        matches!(self, Self::ConflictError(_))
    }

    /// Returns `true` if the error kind is `DeleteAssignmentError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `DeleteAssignmentError::ThrottlingError`.
    pub fn is_throttling_error(&self) -> bool {
        matches!(self, Self::ThrottlingError(_))
    }
}
impl ::std::error::Error for DeleteAssignmentError {
...
impl ::std::fmt::Display for DeleteAssignmentError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for DeleteAssignmentError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteAssignmentError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteAssignmentError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_assignment::DeleteAssignmentError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use crate::operation::delete_assignment::_delete_assignment_input::DeleteAssignmentInput;
pub use crate::operation::delete_assignment::_delete_assignment_output::DeleteAssignmentOutput;

mod _delete_assignment_input;

mod _delete_assignment_output;
