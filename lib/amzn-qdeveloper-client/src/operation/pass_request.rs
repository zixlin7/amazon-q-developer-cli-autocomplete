...
/// Orchestration and serialization glue logic for `PassRequest`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct PassRequest;
impl PassRequest {
    /// Creates a new `PassRequest`
    pub fn new() -> Self {
        Self
    }
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::pass_request::PassRequestError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::pass_request::PassRequestOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PassRequest {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PassRequest");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            PassRequestRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PassRequestResponseDeserializer),
        );
    ...
    fn runtime_components(
        ...
        .with_interceptor(PassRequestEndpointParamsInterceptor)
...
#[derive(Debug)]
struct PassRequestResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PassRequestResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_pass_request::de_pass_request_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_pass_request::de_pass_request_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct PassRequestRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PassRequestRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::pass_request::PassRequestInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::pass_request::PassRequestInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonQDeveloperService.PassRequest",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_pass_request::ser_pass_request_input(&input)?,
        );
...
#[derive(Debug)]
struct PassRequestEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PassRequestEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "PassRequestEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<PassRequestInput>()
            .ok_or("failed to downcast to PassRequestInput")?;
...
/// Error type for the `PassRequestError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum PassRequestError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PassRequestError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl PassRequestError {
    /// Creates the `PassRequestError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `PassRequestError::Unhandled` variant from an
    ...
    /// Returns `true` if the error kind is `PassRequestError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }

    /// Returns `true` if the error kind is `PassRequestError::AccessDeniedError`.
    pub fn is_access_denied_error(&self) -> bool {
        matches!(self, Self::AccessDeniedError(_))
    }

    /// Returns `true` if the error kind is `PassRequestError::ValidationError`.
    pub fn is_validation_error(&self) -> bool {
        matches!(self, Self::ValidationError(_))
    }

    /// Returns `true` if the error kind is `PassRequestError::ServiceQuotaExceededError`.
    pub fn is_service_quota_exceeded_error(&self) -> bool {
        matches!(self, Self::ServiceQuotaExceededError(_))
    }

    /// Returns `true` if the error kind is `PassRequestError::ThrottlingError`.
    pub fn is_throttling_error(&self) -> bool {
        matches!(self, Self::ThrottlingError(_))
    }
}
impl ::std::error::Error for PassRequestError {
...
impl ::std::fmt::Display for PassRequestError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for PassRequestError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for PassRequestError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PassRequestError {
...
impl ::aws_types::request_id::RequestId for crate::operation::pass_request::PassRequestError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use crate::operation::pass_request::_pass_request_input::PassRequestInput;
pub use crate::operation::pass_request::_pass_request_output::PassRequestOutput;

mod _pass_request_input;

mod _pass_request_output;
