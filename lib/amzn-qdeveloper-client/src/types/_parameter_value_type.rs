...
impl ::std::convert::From<&str> for ParameterValueType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ParameterValueType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(
                other.to_owned(),
            )),
        }
    }
...
impl ::std::fmt::Display for ParameterValueType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ParameterValueType::Boolean => write!(f, "BOOLEAN"),
            ParameterValueType::Number => write!(f, "NUMBER"),
            ParameterValueType::String => write!(f, "STRING"),
