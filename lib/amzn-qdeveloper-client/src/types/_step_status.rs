...
/// match stepstatus {
///     StepStatus::Failed => { /* ... */ },
///     StepStatus::BbIDontKnow => { /* ... */ },
///     StepStatus::LlmIDontKnow => { /* ... */ },
...
impl ::std::convert::From<&str> for StepStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "NOT_SUPPORTED" => StepStatus::BbIDontKnow,
            "NO_ANSWER" => StepStatus::LlmIDontKnow,
...
impl StepStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            StepStatus::BbIDontKnow => "NOT_SUPPORTED",
            StepStatus::LlmIDontKnow => "NO_ANSWER",
    ...
    pub const fn values() -> &'static [&'static str] {
        &["FAILED", "NOT_SUPPORTED", "NO_ANSWER", "SUCCESSFUL"]
    }
}
...
impl ::std::fmt::Display for StepStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            StepStatus::BbIDontKnow => write!(f, "NOT_SUPPORTED"),
            StepStatus::LlmIDontKnow => write!(f, "NO_ANSWER"),
            StepStatus::Successful => write!(f, "SUCCESSFUL"),
